...
> 更新: 2026-07-25（**教学 4 处卡死修复已上生产** —— 齐齐报的第一关卡死查出是一类问题，
> 五关走查、3 关原本通不了关；五关全部 preview 实测通关，字节+功能验证）。
> 更早同日已在生产：iPad 横屏 P1 A（卡锁 5:7 + cqh 排版）、横屏 P0、guest 自选 SP、三技能修复、能量公式。
> 待收反馈：教学能不能顺畅打通 + P1 A 观感（尤其竖屏变化）+ 虎鲸数值。
>
...
## ⚠️ 当前 git / 生产状态
- **HEAD = origin/main = 生产 = `7ba8cb7`**，干净树。测试 **66/66 绿**，lint 干净。
