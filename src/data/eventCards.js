...
const eventCards = [
...

  {
    ...
    skills: [],
    scienceCard: "当抗生素杀死大部分细菌时，少数天生耐药的个体存活下来并大量繁殖。这就是自然选择——达尔文进化论在微观世界的完美体现！这也是为什么不能随便停药。当少数天生耐药的细菌存活下来并大量繁殖——整个群体就对这种药物免疫了。这就是游戏里的'免疫科技系'！",
    evolutionFrom: null,
    evolutionTo: null,
    tags: [],
  },
...

  {
    ...
    spSummonRule: {
      type: "faction_only",
      factionLimit: "tech",
      maxCost: 5, // = max(本卡 cost(2)+3, 科技系最低 SP 费 5) —— 科技系本就没有 6 费 SP，
                  //   旧值 6 是个空头承诺（实际永远只能招到纳米机器人 5 费），改 5 后行为完全不变。
    },
    skills: [],
