...
const cards = [
...

  {
    ...
    tags: ["cnidarian", "venomous", "marine"],
  },

  {
    ...
    scienceCard: "向日葵会追着太阳转，是为了让叶子和花盘尽可能多地接收阳光——这就是光合作用：植物用阳光+水+空气里的二氧化碳，造出糖和氧气。地球上几乎所有生命的能量，都是从植物的这一步开始的！（附加趣事：向日葵的种子排列符合斐波那契数列，大自然也懂数学！）",
    evolutionFrom: null,
...

  {
    ...
    evolutionTo: null,
    tags: ["carnivorous", "carnivorous_plant"],
  },
...

  {
    ...
    scienceCard: "蓝鲸是地球有史以来最大的动物——比最大的恐龙还大！它的叫声可达188分贝，能传播上千公里，是动物界最响亮的声音——这就是'声纳震荡'的来源！蓝鲸深潜时心跳能降到每分钟只有2次，节省氧气在水下待更长时间。最不可思议的是：这么大的动物，吃的却是海里最小的磷虾——一天要吃4吨！",
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["mammal", "marine", "filter_feeder"],
  },
...

  {
    ...
    scienceCard: "皮肤是你身体最大的器官，也是免疫系统的第一道防线——像城墙一样把细菌和病毒挡在外面！只有皮肤破损（伤口）时，病原体才有机会进入身体。皮肤每27天全部换新一次，你一辈子大约会掉40公斤的死皮。",
    evolutionFrom: null,
    evolutionTo: null,
    tags: [],
  },
    ...
    skills: [
      {
        ...
        type: "unique",
        description: "攻击时劫持目标神经，使其 ATK -1000，持续 2 回合",
        scienceNote: "狂犬病毒沿着外周神经逆向传播到大脑，劫持神经系统改变宿主行为——游戏里化作攻击时削弱对手"
      }
    ],
...

  {
    ...
    scienceCard: "肉毒毒素阻断神经末梢释放信号，让肌肉接收不到'收缩'的指令，所以会麻痹！它是世界上最毒的东西——比眼镜蛇毒强一百万倍。但科学家把它变成了美容神器：微量注射能让皱纹的肌肉'安静'下来，这就是肉毒素（Botox）！同一种东西，用多了是毒药，用少了是药物。",
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["toxin"],
  },
...

  {
    ...
    scienceCard: "最早的体温计是伽利略发明的，有一米多长！你发烧时体温升高，其实是身体在\"开暖气\"对抗病菌——因为大部分细菌在高温下会变弱。所以适度发烧是你的免疫系统在努力工作！体温计帮医生发现你有没有发烧——就像帮你看到对手最危险的底牌！",
    evolutionFrom: null,
...

  {
    ...
    scienceCard: "听诊器是因为一个尴尬的故事发明的！医生雷奈克需要听一位女病人的心跳，但直接把耳朵贴上去太不礼貌了，于是他卷了一筒纸当\"传声筒\"，发现效果特别好！听诊器能听到心跳、呼吸和肠道蠕动声——医生通过这些声音判断你的身体状况，就像给身体做'声音体检'！",
    evolutionFrom: null,
    evolutionTo: null,
    tags: [],
  },
...

  {
    ...
    scienceCard: "第一个用显微镜看到细菌的人叫列文虎克，他是一个荷兰的布料商人！他自己磨镜片做了几百台显微镜，发现水滴里竟然住着无数\"小动物\"。没有显微镜，我们根本不知道世界上还有细菌和病毒！列文虎克第一次在显微镜下看到细菌时，整个世界都被打开了——知道敌人长什么样，才能更好地对付它！",
    evolutionFrom: null,
...

  {
    ...
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["bryophyte", "terrestrial", "ancient"],
  },
...

  {
    ...
    scienceCard: "蜘蛛不是昆虫！它们有8条腿，属于蛛形纲。蜘蛛用比钢丝还结实的丝织出网来黏住猎物，猎物越挣扎被缠得越紧——这就是为什么被蜘蛛丝缠住后攻击力会变弱！科学家正在研究用蜘蛛丝做防弹衣呢。",
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["arachnid"],
  },

  {
    ...
    scienceCard: "萤火虫的光是'冷光'，效率高达95%——电灯泡只有10%的能量变成光！在完全黑暗的夜晚，萤火虫的光是唯一的'通讯信号'——它们用闪光来寻找伴侣。就像它帮你看到了对手最危险的底牌！",
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["insect","bioluminescent","aerial"],
  },

  {
    ...
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["reptile","endangered","marine"],
  },
...

  {
    ...
    scienceCard: "大花草是世界上最大的花，直径可达1米！它散发腐肉般的恶臭，不是为了驱赶敌人，而是为了吸引苍蝇来帮它传粉——这就是植物跟动物'合作'的方式。它没有根也没有叶子，寄生在其他植物身上，是一种非常独特的寄生植物！",
    evolutionFrom: null,
    evolutionTo: null,
...

  {
    ...
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["cartilaginous_fish","predator","marine"],
  },

  {
    ...
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["cephalopod","invertebrate","marine"],
  },
...

  {
    ...
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["mammal","endangered","terrestrial"],
  },
...

  {
    ...
    scienceCard: "草履虫形状像一只小草鞋，是最经典的单细胞生物。它的繁殖方式超简单——直接从中间一分为二，一个变两个！条件好的时候几小时就能翻一倍。这就是'二分裂'——地球上最古老、最高效的生命延续方式！",
    evolutionFrom: null,
    evolutionTo: null,
...

  {
    ...
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["cartilaginous_fish","endangered","filter_feeder","marine"],
  },
    ...
    skills: [
          {
                ...
                "type": "unique",
                "description": "每 2 回合抽 1 张牌（胸腺源源不断产出新的免疫细胞）",
                "scienceNote": "胸腺'教育'T细胞识别自己和敌人，只有通过考试的T细胞才能毕业——胸腺每天产出大量新的免疫细胞"
          }
    ],
...

  {
    ...
    scienceCard: "诺如病毒是传播力最恐怖的病毒之一——只需要18个病毒颗粒就能让你病倒（大多数病毒需要上千个）！感染后会剧烈呕吐和腹泻，一次呕吐就能释放上百万个病毒颗粒。冬天的学校食堂和游轮上最容易爆发。",
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["RNA_virus"],
  },
...

  {
    ...
    scienceCard: "沙门氏菌是食物中毒最常见的元凶！它们藏在没煮熟的鸡蛋和鸡肉里，通过消化道直接攻击肠胃——这就是为什么食物中毒总是肚子疼、拉肚子、发烧。所以鸡蛋和肉一定要完全煮熟哦！",
    evolutionFrom: null,
    evolutionTo: null,
    tags: ["gram_negative"],
  },
...

  {
    ...
    scienceCard: "验血是医生了解你身体状况最快的方法之一！一滴血就能检测出几百种信息：有没有感染、血糖高不高、肝肾功能好不好。一滴血就能告诉医生几百种信息——就像一次看穿了对手所有的底牌！",
    evolutionFrom: null,
    evolutionTo: null,
    tags: [],
  },
