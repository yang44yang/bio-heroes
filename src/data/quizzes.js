...
export const quizzes = [
  ...
  // — 🦠 病原系 (3 题) —
  { q: "妈妈说'我们小时候打过牛痘疫苗，你不用打天花疫苗了'。这是因为？", options: ["因为牛痘疫苗的保护能传给下一代", "因为天花已被人类彻底消灭，没有病毒了", "因为现代医学已经能直接治好天花", "因为天花病毒已经进化成对人无害"], answer: 1, fact: "1980 年 WHO 宣布天花根除——这是人类唯一彻底消灭的传染病。没有病毒就不需要疫苗。但请注意：'根除'是极少数情况，大部分传染病还是要持续接种。", difficulty: "hard", faction: "pathogen", cardId: "smallpox_ghost", type: "inference", principle: "tradeoff", tags: ["ch2","eradication"] },
  ...
  { q: "为什么得过水痘的人一般不会再得第二次？", options: ["水痘病毒只感染一次，然后就离开了身体", "身体留下了认识水痘的抗体，再来能马上识别消灭", "第一次得病后皮肤会变厚挡住病毒", "水痘会让人对所有病毒都免疫"], answer: 1, fact: "记忆 B 细胞 + 抗体会长期保留——再次遇到同样病原能秒识别+秒消灭。但要注意：水痘病毒可能潜伏在神经里，多年后变带状疱疹（同一病毒不同表现）。", difficulty: "hard", faction: "body", cardId: "antibody_precision_ssr", type: "inference", principle: "mechanism", tags: ["ch2","immune_memory"] },
  ...
  { q: "为什么高原上人会感到呼吸困难？", options: ["因为高原空气稀薄，氧气分子少，肺要更努力呼吸", "因为高原温度太低让肺冻得不灵活", "因为高原的风把肺周围的氧气吹走了", "因为高原的水太少肺不够湿润"], answer: 0, fact: "高海拔气压低 → 每口气吸进去的氧气分子比平原少 → 肺和心脏都要加倍工作。这就是为什么登山者会呼吸急促。长期高原居民的肺活量、血红蛋白会适应增加。", difficulty: "hard", faction: "body", cardId: "lung_engine", type: "inference", principle: "homeostasis", tags: ["ch2","altitude","adaptation"] },
  ...
  // — ⚗️ 科技系 (18 题) —
  { q: "妈妈说酒精洗手液对'诺如病毒'（冬天容易得的呕吐病）效果差，要用肥皂。为什么？", options: ["因为酒精在低温环境下杀菌效果会减弱", "因为诺如病毒没脂质膜，酒精破不了，得靠肥皂冲走", "因为肥皂的成分能改变病毒表面的蛋白结构", "因为诺如病毒能在酒精里短暂存活几分钟"], answer: 1, fact: "诺如病毒没有'脂质包膜'——酒精破坏脂膜的常用招对它无效。但肥皂能物理把它从皮肤'剥离'冲走。所以胃肠炎流行季要用肥皂洗手，不能光靠免洗洗手液。", difficulty: "hard", faction: "tech", cardId: "hand_sanitizer", type: "inference", principle: "mechanism", tags: ["ch2","norovirus"] },
  ...
  { q: "基因治疗一次就能治好的病，为什么不被广泛用来治所有遗传病？", options: ["基因治疗难精准送到坏基因所在的细胞，而且贵", "因为基因治疗只对未成年小朋友有治疗效果", "因为基因治疗会让被治的人外貌发生改变", "因为基因治疗的效果只能维持几个月就失效"], answer: 0, fact: "基因治疗的难点：1) 病毒载体把正确基因送到对的细胞类型；2) 一次治疗几百万到几千万元；3) 长期效果未知。所以目前只用于致命且无药可治的遗传病。", difficulty: "hard", faction: "tech", cardId: "gene_therapy_fix", type: "inference", principle: "tradeoff", tags: ["ch2","cost","accessibility"] },
  { q: "尿毒症病人需要每周去医院做几次透析，为什么不能在家自己做？", options: ["因为透析机太复杂，需要专业医生监控防止意外", "因为家里的水不够干净", "因为透析机怕家里的灰尘", "因为病人喜欢去医院聊天"], answer: 0, fact: "透析过程要监测血压、电解质、凝血等——任何异常都可能致命。其实有'居家透析'技术，但需要严格培训。多数病人选医院透析更安全。这是'安全 vs 便利' tradeoff。", difficulty: "hard", faction: "tech", cardId: "dialysis_machine", type: "inference", principle: "tradeoff", tags: ["ch2","safety"] },
  ...
  { q: "纳米机器人能精准治癌，为什么还没普及给所有癌症病人？", options: ["因为癌症病人不需要这么先进的技术", "因为纳米机器人成本超高难以负担", "因为还在研究阶段，实际应用还很有限", "因为癌症已经无药可治没必要用"], answer: 2, fact: "纳米机器人很多还在动物实验，临床应用刚起步。实际治疗要解决：靶向精度、副作用、量产、监管批准等——'未来技术'到'人人能用'之间还有很长的路。", difficulty: "hard", faction: "tech", cardId: "nanobot_warrior", type: "inference", principle: "tradeoff", tags: ["ch2","frontier"] },
  { q: "如果有人想用 CRISPR 让自己变得'更聪明'，为什么这非常危险？", options: ["因为 CRISPR 一次只能改一个基因，效率不够", "因为聪明涉及上千个基因，改一个可能引发未知后果", "因为目前还没找到决定聪明的关键基因位置", "因为 CRISPR 修改脑细胞时会让脑容量缩小"], answer: 1, fact: "智力涉及上千个基因 + 教育/营养/经历等环境因素。改一个基因可能引发蝴蝶效应（其他功能受影响）。2018 年贺建奎案就是滥用 CRISPR 改胚胎基因的反例——医学和伦理都不允许。", difficulty: "hard", faction: "tech", cardId: "crispr_editor", type: "inference", principle: "tradeoff", tags: ["ch2","ethics","complexity"] },
  ...
  { q: "什么样的伤口不适合用创可贴？", options: ["太小的伤口（一道刮痕）", "大伤口或感染严重的伤口，需要专门处理", "身上各处的小伤口", "已经不流血的小伤口"], answer: 1, fact: "创可贴只适合干净的小伤口。大伤口、深伤口、感染明显的伤口需要医生处理（缝合、清创、抗生素）。错用创可贴可能把感染'封'在里面更严重。", difficulty: "hard", faction: "tech", cardId: "bandaid_helper", type: "inference", principle: "tradeoff", tags: ["ch2","first_aid"] },
