...
const cardQuizzes = [
  ...
  { q: "蚂蚁是用什么方式告诉同伴食物在哪里的？", options: ["唱歌", "跳舞", "释放信息素", "打手势"], answer: 2, fact: "蚂蚁通过释放化学信号（信息素）来和同伴交流，形成化学通讯网络！", difficulty: "easy", faction: "nature", cardId: "ant_soldier", type: "memorization", tags: ["legacy","ant","communication"] },
  { q: "一只蚂蚁大约能举起自己体重多少倍的东西？", options: ["5倍", "10倍", "50倍", "100倍"], answer: 2, fact: "蚂蚁能举起自身体重50倍的东西，相当于你举起一辆卡车！", difficulty: "medium", faction: "nature", cardId: "ant_soldier", type: "memorization", tags: ["legacy","ant","strength"] },
  { q: "切叶蚁搬回的叶子不是自己吃，而是用来'种蘑菇'——它和蘑菇到底是什么关系？", options: ["蘑菇是切叶蚁的天敌，必须铲除干净", "互相依靠：蚁种菌、菌喂蚁，谁也离不开谁", "切叶蚁只是把蘑菇当临时的小零食", "蘑菇会抢切叶蚁的口粮，是竞争对手"], answer: 1, fact: "切叶蚁把嚼碎的叶子当'肥料'专门培育一种蘑菇，再靠吃这种蘑菇活命；而这种蘑菇也只能靠切叶蚁种植、离开蚁巢就活不了。两者'绑定'了几千万年，谁也离不开谁——这叫互利共生。", difficulty: "hard", faction: "nature", cardId: "ant_soldier", type: "mechanism", principle: "coevolution", tags: ["ch3","ant","symbiosis"] },
  { q: "蚂蚁睡觉吗？", options: ["不睡觉，24小时工作", "每天打几百次1分钟的小盹", "像人一样睡8小时", "冬天才睡"], answer: 1, fact: "工蚁每天会打大约250次小盹，每次只有1分钟左右！所以任何时候蚁群里都有蚂蚁是醒着的。", difficulty: "hard", faction: "nature", cardId: "ant_soldier", type: "memorization", tags: ["legacy","ant","sleep"] },
  { q: "地球上数量最多的昆虫是什么？", options: ["蟑螂", "蚊子", "蚂蚁", "蜜蜂"], answer: 2, fact: "蚂蚁是地球上数量最多的昆虫之一，估计总数超过20万亿只！", difficulty: "easy", faction: "nature", cardId: "ant_soldier", type: "memorization", tags: ["legacy","ant","abundance"] },

  { q: "含羞草被碰到后叶子会怎样？", options: ["变红", "合拢", "变大", "发光"], answer: 1, fact: "含羞草被碰到后叶片会迅速合拢下垂，像是在\"害羞\"！其实是一种防御反应。", difficulty: "easy", faction: "nature", cardId: "mimosa_timid", type: "memorization", tags: ["legacy","mimosa","touch_response"] },
  { q: "如果反复碰含羞草，它会怎样？", options: ["叶子掉光", "不再合拢", "长出刺", "变色"], answer: 1, fact: "反复碰含羞草后它会\"习惯\"不再合拢，科学家认为这是植物的一种简单\"学习\"能力！", difficulty: "hard", faction: "nature", cardId: "mimosa_timid", type: "memorization", tags: ["legacy","mimosa","habituation"] },
  { q: "含羞草的叶子合拢是因为什么？", options: ["肌肉收缩", "叶枕细胞失水", "叶子枯萎了", "风吹的"], answer: 1, fact: "含羞草叶子合拢是因为叶枕的细胞突然失水，导致叶片快速下垂！", difficulty: "hard", faction: "nature", cardId: "mimosa_timid", type: "mechanism", principle: "mechanism", tags: ["legacy","mimosa","turgor"] },
  { q: "植物能\"听到\"声音吗？", options: ["不能", "能感知振动并做出反应", "只能听到音乐", "只有花能听到"], answer: 1, fact: "研究发现植物能感知声波振动！有的植物\"听到\"毛虫咀嚼声后会增加防御化学物质的分泌。", difficulty: "hard", faction: "nature", cardId: "mimosa_timid", type: "memorization", tags: ["legacy","plant","sound_sensing"] },

  { q: "蜜蜂蜇人后自己会怎样？", options: ["没事", "变强", "会死", "会飞走"], answer: 2, fact: "蜜蜂的蜂刺有倒钩，蜇人后内脏会被拉出来，蜜蜂自己也会死。", difficulty: "easy", faction: "nature", cardId: "bee_worker", type: "memorization", principle: "tradeoff", tags: ["legacy","bee","stinger"] },
  { q: "蜜蜂用什么方式告诉同伴花在哪里？", options: ["叫声", "8字舞", "颜色变化", "触角碰触"], answer: 1, fact: "蜜蜂会跳\"8字舞\"（摇摆舞），用舞蹈的方向和速度告诉同伴花朵的方位和距离！", difficulty: "medium", faction: "nature", cardId: "bee_worker", type: "memorization", tags: ["legacy","bee","waggle_dance"] },
  { q: "一只蜜蜂一辈子大约能酿多少蜂蜜？", options: ["一瓶", "一杯", "一茶匙", "一滴"], answer: 2, fact: "一只蜜蜂一辈子只能酿大约一茶匙的蜂蜜！但一个蜂群合作一年能酿30公斤。", difficulty: "medium", faction: "nature", cardId: "bee_worker", type: "memorization", tags: ["legacy","bee","honey_scale"] },
  { q: "蜜蜂能看到什么人类看不到的光？", options: ["红外线", "紫外线", "X射线", "微波"], answer: 1, fact: "蜜蜂能看到紫外线！很多花朵在紫外线下有特殊图案，引导蜜蜂找到花蜜。", difficulty: "hard", faction: "nature", cardId: "bee_worker", type: "memorization", tags: ["legacy","bee","uv_vision"] },

  { q: "水母的身体有百分之多少是水？", options: ["50%", "75%", "85%", "95%"], answer: 3, fact: "水母身体95%都是水！没有大脑、没有心脏，却在海洋中生存了6亿多年。", difficulty: "easy", faction: "nature", cardId: "jellyfish_stealth", type: "memorization", tags: ["legacy","jellyfish","water_content"] },
  { q: "哪种水母理论上可以\"永生\"？", options: ["箱形水母", "灯塔水母", "月亮水母", "狮鬃水母"], answer: 1, fact: "灯塔水母能把自己变回幼年状态重新生长，理论上可以无限循环！", difficulty: "hard", faction: "nature", cardId: "jellyfish_stealth", type: "memorization", tags: ["legacy","jellyfish","immortality"] },
  { q: "水母有大脑吗？", options: ["有一个很大的", "有一个很小的", "没有大脑", "有两个"], answer: 2, fact: "水母没有大脑！靠简单的神经网络来感知环境，是地球上最古老的动物之一。", difficulty: "easy", faction: "nature", cardId: "jellyfish_stealth", type: "memorization", tags: ["legacy","jellyfish","no_brain"] },
  { q: "水母的刺细胞射出毒针的速度有多快？", options: ["1秒", "0.01秒", "700纳秒", "1分钟"], answer: 2, fact: "水母刺细胞射出毒针只需700纳秒，是自然界最快的细胞反应！", difficulty: "hard", faction: "nature", cardId: "jellyfish_stealth", type: "memorization", tags: ["legacy","jellyfish","nematocyst"] },
  { q: "世界上最毒的动物是什么？", options: ["眼镜蛇", "箱形水母", "蝎子", "河豚"], answer: 1, fact: "箱形水母是世界上最毒的动物之一，毒液可以在几分钟内导致心脏停跳！", difficulty: "medium", faction: "nature", cardId: "jellyfish_stealth", type: "memorization", tags: ["legacy","jellyfish","venom"] },

  { q: "向日葵会追着什么转？", options: ["月亮", "风", "太阳", "雨"], answer: 2, fact: "向日葵幼苗会追着太阳转（向光性），但长大后就固定朝东了！", difficulty: "easy", faction: "nature", cardId: "sunflower_charger", type: "memorization", tags: ["legacy","sunflower","heliotropism"] },
  { q: "向日葵上的小花排列遵循什么数学规律？", options: ["九九乘法表", "斐波那契数列", "圆周率", "等差数列"], answer: 1, fact: "向日葵的种子排列符合斐波那契数列，大自然也懂数学！", difficulty: "hard", faction: "nature", cardId: "sunflower_charger", type: "memorization", tags: ["legacy","sunflower","fibonacci"] },
  { q: "一朵向日葵上其实有多少朵小花？", options: ["1朵", "10朵", "上百朵", "上千朵"], answer: 3, fact: "一朵向日葵看起来是一朵花，其实是由上千朵小花组成的！", difficulty: "medium", faction: "nature", cardId: "sunflower_charger", type: "memorization", tags: ["legacy","sunflower","composite_flower"] },

  { q: "电鳗最高能释放多少伏特的电？", options: ["100伏特", "400伏特", "860伏特", "2000伏特"], answer: 2, fact: "电鳗能释放高达860伏特的电击！身体80%都是发电器官。", difficulty: "medium", faction: "nature", cardId: "electric_eel_battery", type: "memorization", tags: ["legacy","electric_eel","voltage"] },
  { q: "电鳗其实是什么鱼？", options: ["真正的鳗鱼", "裸背电鱼", "鲶鱼", "鳐鱼"], answer: 1, fact: "电鳗其实不是鳗鱼，而是一种南美洲的裸背电鱼！", difficulty: "hard", faction: "nature", cardId: "electric_eel_battery", type: "memorization", tags: ["legacy","electric_eel","taxonomy"] },
  { q: "电鳗除了捕猎，还用电做什么？", options: ["给手机充电", "在浑浊的水中探路", "吸引异性", "照明"], answer: 1, fact: "电鳗还会释放弱电脉冲来像雷达一样在浑浊的亚马逊河中探路！", difficulty: "medium", faction: "nature", cardId: "electric_eel_battery", type: "memorization", tags: ["legacy","electric_eel","electrolocation"] },

  { q: "猎豹的最快速度大约是多少？", options: ["60公里/时", "80公里/时", "120公里/时", "200公里/时"], answer: 2, fact: "猎豹时速可达120公里，3秒就能加速到100公里/时！", difficulty: "easy", faction: "nature", cardId: "cheetah_sprinter", type: "memorization", tags: ["legacy","cheetah","speed"] },
  { q: "猎豹高速奔跑最多能持续多久？", options: ["5秒", "30秒", "2分钟", "10分钟"], answer: 1, fact: "猎豹只能维持约30秒的高速奔跑，之后体温过热必须停下来！", difficulty: "medium", faction: "nature", cardId: "cheetah_sprinter", type: "memorization", principle: "tradeoff", tags: ["legacy","cheetah","overheating"] },
  { q: "猎豹跑步时尾巴有什么作用？", options: ["装饰好看", "像方向盘帮助转弯", "保持温暖", "吓跑敌人"], answer: 1, fact: "猎豹的长尾巴在高速奔跑时像方向盘和平衡器，帮助它急转弯时不会摔倒！", difficulty: "easy", faction: "nature", cardId: "cheetah_sprinter", type: "memorization", tags: ["legacy","cheetah","tail_balance"] },

  { q: "捕蝇草需要碰几次感觉毛才会合拢？", options: ["1次", "2次", "3次", "5次"], answer: 1, fact: "捕蝇草会\"数数\"！必须碰到感觉毛2次才会触发夹合，避免被雨滴误触。", difficulty: "medium", faction: "nature", cardId: "venus_flytrap", type: "memorization", tags: ["legacy","venus_flytrap","trigger_count"] },
  { q: "捕蝇草是怎么消化虫子的？", options: ["嚼碎吃掉", "分泌消化液慢慢溶解", "交给根部消化", "不消化"], answer: 1, fact: "捕蝇草合拢后会分泌消化液慢慢溶解虫子，整个过程需要5-12天！", difficulty: "medium", faction: "nature", cardId: "venus_flytrap", type: "mechanism", principle: "mechanism", tags: ["legacy","venus_flytrap","digestion"] },
  { q: "捕蝇草为什么要\"吃\"虫子？", options: ["因为好玩", "因为土壤缺少营养", "因为不能光合作用", "因为虫子味道好"], answer: 1, fact: "捕蝇草生长在贫瘠的沼泽地，土壤缺氮和磷，通过捕食昆虫来补充营养！", difficulty: "hard", faction: "nature", cardId: "venus_flytrap", type: "inference", tags: ["legacy","venus_flytrap","carnivory","nutrients"] },

  { q: "虎鲸其实属于什么科？", options: ["鲸科", "海豚科", "鲨鱼科", "海豹科"], answer: 1, fact: "虎鲸其实是海豚科中体型最大的成员，不是鲸！", difficulty: "medium", faction: "nature", cardId: "orca_alpha", type: "memorization", tags: ["legacy","orca","taxonomy"] },
  { q: "虎鲸家族之间用什么交流？", options: ["手语", "独特的叫声方言", "颜色变化", "电信号"], answer: 1, fact: "不同虎鲸家族有自己独特的\"方言\"——一套只有家人能听懂的叫声系统！", difficulty: "hard", faction: "nature", cardId: "orca_alpha", type: "memorization", tags: ["legacy","orca","dialect"] },
  { q: "虎鲸会把浮冰上的海豹怎么弄下水？", options: ["跳上冰面", "制造浪涌冲下来", "用嘴叼下来", "等冰融化"], answer: 1, fact: "虎鲸会协同游泳制造巨浪，把浮冰上的海豹冲入水中！", difficulty: "medium", faction: "nature", cardId: "orca_alpha", type: "mechanism", principle: "mechanism", tags: ["legacy","orca","wave_hunting"] },
  { q: "虎鲸的家庭结构是什么样的？", options: ["雄性领导", "母系社会", "独居生活", "随机群居"], answer: 1, fact: "虎鲸是母系社会，妈妈是家族核心领袖，孩子一辈子都跟着妈妈！", difficulty: "medium", faction: "nature", cardId: "orca_alpha", type: "memorization", tags: ["legacy","orca","matriarchy"] },

  { q: "蓝鲸是地球上最大的什么？", options: ["最大的鱼", "最大的动物", "最大的哺乳动物", "最大的海洋生物"], answer: 1, fact: "蓝鲸是地球有史以来最大的动物——比最大的恐龙还大！", difficulty: "easy", faction: "nature", cardId: "blue_whale_titan", type: "memorization", tags: ["legacy","blue_whale","largest"] },
  { q: "蓝鲸宝宝刚出生有多长？", options: ["1米", "3米", "7米", "15米"], answer: 2, fact: "蓝鲸宝宝刚出生就有7米长，每天喝400升奶！", difficulty: "medium", faction: "nature", cardId: "blue_whale_titan", type: "memorization", tags: ["legacy","blue_whale","calf_size"] },
  { q: "蓝鲸的心跳在深潜时会降到每分钟几次？", options: ["60次", "30次", "2次", "不会变"], answer: 2, fact: "蓝鲸深潜时心跳可以降到每分钟只有2次！节省氧气在水下待更长时间。", difficulty: "hard", faction: "nature", cardId: "blue_whale_titan", type: "memorization", principle: "homeostasis", tags: ["legacy","blue_whale","dive_response"] },
  { q: "蓝鲸主要吃什么？", options: ["大鱼", "海草", "磷虾（小虾）", "乌贼"], answer: 2, fact: "最大的动物居然吃最小的食物之一——磷虾！蓝鲸一天能吃4吨磷虾。", difficulty: "easy", faction: "nature", cardId: "blue_whale_titan", type: "memorization", tags: ["legacy","blue_whale","krill_diet"] },

  // 🌱 自然系补充
  { q: "蚂蚁有几条腿？", options: ["4条", "6条", "8条", "10条"], answer: 1, fact: "蚂蚁和所有昆虫一样有6条腿！昆虫的定义就是有6条腿和3段身体。", difficulty: "easy", faction: "nature", cardId: "ant_soldier", type: "memorization", tags: ["legacy","ant","insect_anatomy"] },
  { q: "向日葵的种子可以用来做什么？", options: ["做枕头", "榨油", "做药", "做橡皮"], answer: 1, fact: "向日葵种子可以榨出葵花籽油，也是很好的零食！一朵向日葵可以产出上千颗种子。", difficulty: "easy", faction: "nature", cardId: "sunflower_charger", type: "memorization", tags: ["legacy","sunflower","seed_use"] },
  { q: "猎豹和豹子是同一种动物吗？", options: ["是的", "不是，是不同的物种", "猎豹是小豹子", "豹子是老猎豹"], answer: 1, fact: "猎豹和豹子是完全不同的物种！猎豹体型更瘦、跑得更快，脸上有标志性的黑色\"泪痕\"线条。", difficulty: "easy", faction: "nature", cardId: "cheetah_sprinter", type: "memorization", tags: ["legacy","cheetah","species"] },
  { q: "电鳗生活在哪里？", options: ["太平洋", "北极", "南美洲亚马逊河", "非洲尼罗河"], answer: 2, fact: "电鳗生活在南美洲的亚马逊河和奥里诺科河流域，那里的水很浑浊，所以它们要靠电来\"看路\"。", difficulty: "easy", faction: "nature", cardId: "electric_eel_battery", type: "memorization", tags: ["legacy","electric_eel","habitat"] },
  { q: "蓝鲸的叫声能传多远？", options: ["100米", "1公里", "上千公里", "绕地球一圈"], answer: 2, fact: "蓝鲸的叫声可以传播上千公里！是动物界最响亮的声音，可达188分贝。", difficulty: "medium", faction: "nature", cardId: "blue_whale_titan", type: "memorization", tags: ["legacy","blue_whale","song_range"] },
  { q: "含羞草是有毒的吗？", options: ["完全无毒", "有轻微毒性", "剧毒", "只有根部有毒"], answer: 1, fact: "含羞草全株有轻微毒性，家养的话要注意不要让小孩和宠物误食！", difficulty: "medium", faction: "nature", cardId: "mimosa_timid", type: "memorization", tags: ["legacy","mimosa","toxicity"] },
  { q: "蜜蜂采一瓶蜂蜜需要飞多远？", options: ["1公里", "100公里", "绕地球一圈半", "到月球"], answer: 2, fact: "生产一瓶500克的蜂蜜，蜜蜂们总共需要飞行约6万公里——相当于绕地球一圈半！", difficulty: "hard", faction: "nature", cardId: "bee_worker", type: "memorization", tags: ["legacy","bee","foraging_scale"] },
  { q: "虎鲸在自然界有天敌吗？", options: ["鲨鱼", "蓝鲸", "几乎没有天敌", "人类是唯一天敌"], answer: 2, fact: "虎鲸在自然界几乎没有天敌！它们是真正的海洋顶级掠食者，连大白鲨都会躲开它们。", difficulty: "easy", faction: "nature", cardId: "orca_alpha", type: "memorization", tags: ["legacy","orca","apex_predator"] },

  // ============================================================
  // 🧬 人体系 (body) — 46题
  // ============================================================

  { q: "血小板的主要功能是什么？", options: ["运输营养", "免疫防御", "止血凝血", "产生抗体"], answer: 2, fact: "血小板聚集形成血栓堵住伤口，是受伤后第一道修复防线！", difficulty: "easy", faction: "body", cardId: "platelet_guardian", type: "memorization", tags: ["legacy","platelet","clotting"] },
  { q: "血小板是从哪里产生的？", options: ["心脏", "肝脏", "骨髓", "脾脏"], answer: 2, fact: "血小板是骨髓里的巨核细胞碎裂产生的小碎片。", difficulty: "medium", faction: "body", cardId: "platelet_guardian", type: "memorization", tags: ["legacy","platelet","bone_marrow"] },
  { q: "血小板是完整的细胞吗？", options: ["是的", "不是，是细胞碎片", "有时候是有时候不是", "只在骨髓里是"], answer: 1, fact: "血小板不是完整的细胞，是巨核细胞碎裂出来的小碎片，没有细胞核。", difficulty: "hard", faction: "body", cardId: "platelet_guardian", type: "memorization", tags: ["legacy","platelet","cell_fragment"] },

  { q: "红细胞的主要功能是什么？", options: ["免疫", "运输氧气", "凝血", "消化"], answer: 1, fact: "红细胞含血红蛋白，能与氧气结合进行运输。你身体里有约25万亿个！", difficulty: "easy", faction: "body", cardId: "red_blood_cell", type: "memorization", tags: ["legacy","rbc","oxygen_transport"] },
  { q: "红细胞为什么没有细胞核？", options: ["发育不完全", "为了装更多氧气", "被白细胞吃了", "太小装不下"], answer: 1, fact: "红细胞丢弃细胞核是为了腾出更多空间装载血红蛋白来携带氧气！", difficulty: "hard", faction: "body", cardId: "red_blood_cell", type: "mechanism", principle: "tradeoff", tags: ["legacy","rbc","no_nucleus","hemoglobin"] },
  { q: "为什么红细胞要长成中间凹进去的'小饼'形状？", options: ["圆饼形是为了在血管里叠成一摞流动", "因为装不下细胞核中间才凹了进去", "凹进去能增大表面积，氧气装卸都更快", "这样能滚着走比游泳快得多"], answer: 2, fact: "红细胞中间凹进去的'双凹饼'形状大有讲究：同样体积，凹进去比圆球的表面积大得多 → 氧气进出的'门'更多更快；而且又软又能变形，能挤过比自己还细的毛细血管！", difficulty: "medium", faction: "body", cardId: "red_blood_cell", type: "mechanism", principle: "mechanism", tags: ["ch2","rbc","surface_area"] },
  { q: "你的骨髓每秒钟大约制造多少个新红细胞？", options: ["20个", "2000个", "200万个", "2亿个"], answer: 2, fact: "骨髓每秒钟制造约200万个新红细胞！因为红细胞寿命只有约120天。", difficulty: "hard", faction: "body", cardId: "red_blood_cell", type: "memorization", tags: ["legacy","rbc","production_rate"] },
  { q: "人体有多少百分比是水？", options: ["30%", "45%", "60%", "80%"], answer: 2, fact: "成年人身体大约60%是水！婴儿更高约75%。多喝水真的很重要。", difficulty: "easy", faction: "body", cardId: "red_blood_cell", type: "memorization", tags: ["legacy","body","water_content"] },

  { q: "胃酸的酸性有多强？", options: ["和柠檬汁一样", "和醋一样", "接近盐酸", "比水稍酸"], answer: 2, fact: "胃酸pH值约1.5-3.5，强度接近盐酸，可以溶解金属！", difficulty: "medium", faction: "body", cardId: "stomach_acid", type: "memorization", tags: ["legacy","stomach","acidity"] },
  { q: "胃壁细胞大约多久全部更新一次？", options: ["每天", "3-4天", "一个月", "一年"], answer: 1, fact: "胃壁细胞每3-4天就全部更新一次，这样胃就不会被自己消化掉！", difficulty: "hard", faction: "body", cardId: "stomach_acid", type: "memorization", tags: ["legacy","stomach","cell_renewal"] },
  { q: "为什么胃不会被自己的胃酸消化掉？", options: ["胃酸其实不强", "有一层黏液保护", "胃壁是金属做的", "因为胃很硬"], answer: 1, fact: "胃壁有一层厚厚的黏液保护层，像\"防酸雨衣\"把胃酸和胃壁隔开！", difficulty: "easy", faction: "body", cardId: "stomach_acid", type: "mechanism", principle: "mechanism", tags: ["legacy","stomach","mucus_barrier"] },

  { q: "白细胞在身体里扮演什么角色？", options: ["快递员", "建筑工", "警察和士兵", "清洁工"], answer: 2, fact: "白细胞是身体里的\"警察\"和\"士兵\"，负责消灭入侵的病菌！", difficulty: "easy", faction: "body", cardId: "white_blood_cell", type: "memorization", tags: ["legacy","wbc","immune_role"] },
  { q: "一个白细胞大约能吃掉多少个细菌？", options: ["1-2个", "5-20个", "100个", "1000个"], answer: 1, fact: "中性粒细胞能直接吞噬细菌，一个可以吃掉5-20个！", difficulty: "medium", faction: "body", cardId: "white_blood_cell", type: "memorization", tags: ["legacy","wbc","phagocytosis"] },
  { q: "伤口红肿发热是怎么回事？", options: ["伤口在恶化", "白细胞正在打仗", "需要马上去医院", "血管破了"], answer: 1, fact: "伤口发红发肿是大量白细胞涌到伤口和病菌战斗！这叫\"炎症反应\"。", difficulty: "easy", faction: "body", cardId: "white_blood_cell", type: "mechanism", principle: "mechanism", tags: ["legacy","wbc","inflammation"] },
  { q: "白细胞是怎么从血管跑到受伤部位的？", options: ["沿血管游过去", "穿过血管壁爬过去", "坐红细胞的车", "通过神经传送"], answer: 1, fact: "白细胞能变形穿过血管壁的缝隙！叫\"趋化性\"，沿化学信号找到入侵者位置。", difficulty: "hard", faction: "body", cardId: "white_blood_cell", type: "mechanism", principle: "mechanism", tags: ["legacy","wbc","chemotaxis"] },

  { q: "人体最大的器官是什么？", options: ["心脏", "肝脏", "皮肤", "肺"], answer: 2, fact: "皮肤展开面积约2平方米，是人体最大的器官！每27天全部换新。", difficulty: "easy", faction: "body", cardId: "skin_barrier", type: "memorization", tags: ["legacy","skin","largest_organ"] },
  { q: "你一辈子大约会掉多少公斤的死皮？", options: ["4公斤", "10公斤", "40公斤", "100公斤"], answer: 2, fact: "人一辈子大约掉落40公斤的死皮！家里灰尘很大一部分就是人的死皮细胞。", difficulty: "medium", faction: "body", cardId: "skin_barrier", type: "memorization", tags: ["legacy","skin","dead_skin"] },
  { q: "皮肤多久全部换新一次？", options: ["每天", "每周", "约27天", "每年"], answer: 2, fact: "皮肤细胞约每27天全部更新一次，所以你的皮肤永远都是\"新\"的！", difficulty: "medium", faction: "body", cardId: "skin_barrier", type: "memorization", tags: ["legacy","skin","renewal"] },

  { q: "人脑大约有多少个神经元？", options: ["86万", "8600万", "86亿", "860亿"], answer: 3, fact: "人脑约有860亿神经元，比银河系的星星还多！", difficulty: "medium", faction: "body", cardId: "neuron_messenger", type: "memorization", tags: ["legacy","neuron","count"] },
  { q: "神经信号的传导速度最快可达？", options: ["1米/秒", "12米/秒", "120米/秒", "1200米/秒"], answer: 2, fact: "有髓鞘的神经纤维传导速度最快可达120米/秒，比高铁还快！", difficulty: "hard", faction: "body", cardId: "neuron_messenger", type: "memorization", tags: ["legacy","neuron","signal_speed"] },
  { q: "大脑用了你身体多少百分比的能量？", options: ["2%", "10%", "20%", "50%"], answer: 2, fact: "大脑只占体重2%，但消耗身体20%的能量！思考真的很\"费电\"。", difficulty: "medium", faction: "body", cardId: "neuron_messenger", type: "memorization", tags: ["legacy","brain","energy_use"] },
  { q: "人在睡觉时大脑在做什么？", options: ["完全关机", "整理和巩固记忆", "只控制呼吸", "什么都不做"], answer: 1, fact: "睡觉时大脑在整理知识、巩固记忆、清除废物。这就是为什么睡好觉很重要。", difficulty: "easy", faction: "body", cardId: "neuron_messenger", type: "memorization", tags: ["legacy","brain","sleep_memory"] },
  { q: "人体里最长的细胞是什么？", options: ["红细胞", "白细胞", "神经细胞", "肌肉细胞"], answer: 2, fact: "最长的神经细胞可以从脊髓延伸到脚趾，长度超过1米！", difficulty: "medium", faction: "body", cardId: "neuron_messenger", type: "memorization", tags: ["legacy","neuron","longest_cell"] },
  { q: "你身体里的DNA全部展开能有多长？", options: ["1米", "100米", "从地球到太阳", "绕操场一圈"], answer: 2, fact: "把体内所有细胞的DNA展开接在一起，长度可以从地球到太阳来回好多次！", difficulty: "hard", faction: "body", cardId: "neuron_messenger", type: "memorization", tags: ["legacy","dna","length"] },

  { q: "抗体的形状像什么？", options: ["圆球", "Y字形", "长条", "星形"], answer: 1, fact: "抗体是Y字形的蛋白质，两个\"手臂\"能精确抓住特定病原体！", difficulty: "medium", faction: "body", cardId: "antibody_missile", type: "memorization", tags: ["legacy","antibody","y_shape"] },
  { q: "人体能产生多少种不同的抗体？", options: ["几百种", "几万种", "几百万种", "超过10亿种"], answer: 3, fact: "你的身体能造出超过10亿种不同的抗体，几乎能对付任何入侵者！", difficulty: "hard", faction: "body", cardId: "antibody_missile", type: "memorization", tags: ["legacy","antibody","diversity"] },

  { q: "人的肺泡总面积大约相当于什么？", options: ["一张桌子", "半个网球场", "一个足球场", "一间教室"], answer: 1, fact: "肺里有3亿个肺泡，全部展开面积约70平方米，相当于半个网球场！", difficulty: "easy", faction: "body", cardId: "lung_engine", type: "memorization", tags: ["legacy","lung","alveoli_area"] },
  { q: "为什么左肺比右肺小？", options: ["发育不良", "给心脏留位置", "左边不需要那么大", "基因决定的"], answer: 1, fact: "左肺比右肺小一点，是为了给心脏留出空间！", difficulty: "medium", faction: "body", cardId: "lung_engine", type: "mechanism", principle: "mechanism", tags: ["legacy","lung","asymmetry"] },
  { q: "人每天大约呼吸多少次？", options: ["2000次", "5000次", "2万次", "10万次"], answer: 2, fact: "人每天大约呼吸2万次，大部分时候不用想就自动做了！", difficulty: "easy", faction: "body", cardId: "lung_engine", type: "memorization", tags: ["legacy","lung","breathing_rate"] },

  { q: "成年人有多少块骨头？", options: ["106块", "206块", "306块", "186块"], answer: 1, fact: "婴儿有约300块骨头，长大后很多合并，最终只剩206块！", difficulty: "easy", faction: "body", cardId: "skeleton_frame", type: "memorization", tags: ["legacy","skeleton","bone_count"] },
  { q: "人身上最小的骨头在哪里？", options: ["手指", "脚趾", "耳朵里", "鼻子里"], answer: 2, fact: "人体最小的骨头是耳朵里的镫骨，只有3毫米，比一粒米还小！", difficulty: "medium", faction: "body", cardId: "skeleton_frame", type: "memorization", tags: ["legacy","skeleton","stapes"] },
  { q: "骨头里面是空心的还是实心的？", options: ["完全实心", "里面有骨髓，是活的", "完全空心", "只有表面是活的"], answer: 1, fact: "骨头外面硬里面活！骨骼内部有骨髓，每天生产约2000亿个血液细胞。", difficulty: "easy", faction: "body", cardId: "skeleton_frame", type: "memorization", tags: ["legacy","skeleton","marrow"] },
  { q: "人身上最硬的部分是什么？", options: ["骨头", "指甲", "牙齿的珐琅质", "头骨"], answer: 2, fact: "牙齿表面的珐琅质是人体最硬的物质！比骨头还硬，硬度接近水晶。", difficulty: "medium", faction: "body", cardId: "skeleton_frame", type: "memorization", tags: ["legacy","skeleton","enamel"] },

  { q: "人的心脏一天大约跳动多少次？", options: ["1千次", "1万次", "10万次", "100万次"], answer: 2, fact: "心脏每天跳约10万次，一辈子能跳25亿次！", difficulty: "easy", faction: "body", cardId: "heart_engine", type: "memorization", tags: ["legacy","heart","heartbeat_count"] },
  { q: "为什么心脏离开身体后，还能自己跳动一小会儿？", options: ["因为心脏里存了很多没用完的血", "心脏自带'起搏器'，能自己发出电信号", "因为心肌还记着大脑最后的命令", "因为离开身体后温度升高刺激它"], answer: 1, fact: "心脏里有一小撮特殊细胞叫'窦房结'，是它自带的'发电站'——不用大脑指挥，自己定时放电让心脏跳。所以只要还有氧气和营养，离体的心脏能自己跳一阵。大脑只负责调快慢，并不下'跳'的命令。", difficulty: "hard", faction: "body", cardId: "heart_engine", type: "mechanism", principle: "mechanism", tags: ["ch2","heart","sa_node"] },
  { q: "心脏在身体的哪一侧？", options: ["正中间", "偏左", "偏右", "每个人不一样"], answer: 1, fact: "心脏略偏向左侧，这就是为什么你把手放在左胸能感受到心跳！", difficulty: "easy", faction: "body", cardId: "heart_engine", type: "memorization", tags: ["legacy","heart","position"] },
  { q: "心脏泵出的血液如果接成线能绕地球多少圈？", options: ["半圈", "1圈", "2圈半", "10圈"], answer: 2, fact: "心脏一生泵送约2亿升血液，所有血管接成线能绕地球两圈半！", difficulty: "medium", faction: "body", cardId: "heart_engine", type: "memorization", tags: ["legacy","heart","blood_volume"] },

  // 🧬 人体系补充
  { q: "人一天产生多少口水（唾液）？", options: ["一小杯", "约1升", "约5升", "几乎不产生"], answer: 1, fact: "人每天大约产生1-1.5升唾液！唾液里有消化酶，还能杀灭部分口腔细菌。", difficulty: "easy", faction: "body", cardId: "stomach_acid", type: "memorization", tags: ["legacy","saliva","volume"] },
  { q: "打哈欠会传染吗？", options: ["不会", "会，看到别人打就想打", "只有家人之间会", "只有生病时才会"], answer: 1, fact: "打哈欠确实会\"传染\"！看到或听到别人打哈欠就会想打，科学家认为这可能和共情能力有关。", difficulty: "easy", faction: "body", cardId: "neuron_messenger", type: "memorization", tags: ["legacy","yawn","contagious"] },
  { q: "人的身体里有多少根血管？", options: ["几百根", "几千根", "接起来能绕地球好几圈", "和骨头一样多"], answer: 2, fact: "人体所有血管加起来总长约10万公里，能绕地球两圈半！从大动脉到微毛细血管遍布全身。", difficulty: "medium", faction: "body", cardId: "heart_engine", type: "memorization", tags: ["legacy","blood_vessels","length"] },
  { q: "人能几天不喝水？", options: ["1天", "大约3天", "一周", "一个月"], answer: 1, fact: "人大约只能3天不喝水就会有生命危险！水对所有身体机能都至关重要。", difficulty: "easy", faction: "body", cardId: "red_blood_cell", type: "memorization", tags: ["legacy","body","water_survival"] },
  { q: "眨眼的速度有多快？", options: ["1秒", "0.3-0.4秒", "0.01秒", "5秒"], answer: 1, fact: "一次眨眼只需要0.3-0.4秒！人每分钟大约眨眼15-20次，一天眨眼约1万5千次。", difficulty: "medium", faction: "body", cardId: "neuron_messenger", type: "memorization", tags: ["legacy","eye","blink_speed"] },
  { q: "人的味蕾能分辨几种基本味道？", options: ["2种", "4种", "5种", "10种"], answer: 2, fact: "人的味蕾能分辨5种基本味道：甜、咸、酸、苦、鲜（umami）！鲜味是日本科学家发现的。", difficulty: "medium", faction: "body", cardId: "stomach_acid", type: "memorization", tags: ["legacy","taste","five_tastes"] },
  { q: "人的指纹是独一无二的吗？", options: ["不是，很多人一样", "是的，每个人都不同", "双胞胎一样", "长大后会变"], answer: 1, fact: "每个人的指纹都是独一无二的！即使是同卵双胞胎也有不同的指纹。指纹在胎儿时期就形成了。", difficulty: "easy", faction: "body", cardId: "skin_barrier", type: "memorization", tags: ["legacy","skin","fingerprint"] },
  { q: "骨折后骨头能自己长好吗？", options: ["不能，必须换新骨头", "能，骨头会自己愈合", "只有小孩能", "只能用石膏粘住"], answer: 1, fact: "骨头有强大的自愈能力！骨折后身体会派出特殊的骨细胞来修复裂缝，通常6-8周就能长好。", difficulty: "easy", faction: "body", cardId: "skeleton_frame", type: "memorization", tags: ["legacy","skeleton","bone_healing"] },

  // ============================================================
  // 🦠 病原系 (pathogen) — 44题
  // ============================================================

  { q: "为什么每年需要重新打流感疫苗？", options: ["疫苗会过期", "身体会忘记", "病毒会变异", "医生要赚钱"], answer: 2, fact: "流感病毒变异速度极快，每年都在\"换衣服\"，所以免疫系统认不出它！", difficulty: "easy", faction: "pathogen", cardId: "flu_virus", type: "mechanism", principle: "mechanism", tags: ["legacy","flu","mutation","vaccine"] },
  { q: "流感病毒的大小大约是多少？", options: ["和沙粒一样大", "用放大镜能看到", "比头发丝细1000倍", "和红细胞一样大"], answer: 2, fact: "流感病毒直径只有约100纳米，比头发丝细1000倍！", difficulty: "medium", faction: "pathogen", cardId: "flu_virus", type: "memorization", tags: ["legacy","flu","size"] },
  { q: "为什么一个喷嚏就可能把感冒传给旁边的人？", options: ["喷嚏的声音会震掉别人身上的抵抗力", "喷嚏的热气会烫伤别人鼻子让病钻入", "病毒顺着喷嚏的风自己长出翅膀飞", "喷嚏喷出上万带病毒的飞沫，又远又快"], answer: 3, fact: "一个喷嚏能喷出上万颗小飞沫，速度可达每小时上百公里、飞好几米远，每颗都裹着病毒。旁边的人一吸入，病毒就搭上了'顺风车'。这就是为什么打喷嚏要捂口鼻、生病要戴口罩！", difficulty: "medium", faction: "pathogen", cardId: "flu_virus", type: "mechanism", principle: "mechanism", tags: ["ch2","flu","droplet_transmission"] },
  { q: "病毒和细菌有什么区别？", options: ["没区别", "病毒更大", "病毒不能自己繁殖，要寄生在细胞里", "细菌是好的病毒是坏的"], answer: 2, fact: "病毒不是细胞，不能自己繁殖——必须入侵活细胞才能复制自己。细菌是独立细胞。", difficulty: "medium", faction: "pathogen", cardId: "flu_virus", type: "mechanism", principle: "mechanism", tags: ["legacy","virus","bacteria","replication"] },
  { q: "抗生素能杀死病毒吗？", options: ["能", "不能", "有时候能", "只能杀死大病毒"], answer: 1, fact: "抗生素只能杀细菌，对病毒完全无效！所以感冒吃抗生素没用。", difficulty: "easy", faction: "pathogen", cardId: "flu_virus", type: "memorization", tags: ["legacy","antibiotic","virus_ineffective"] },

  { q: "蛀牙是怎么形成的？", options: ["虫子咬的", "细菌产生酸侵蚀牙齿", "牙齿自然老化", "喝水太多"], answer: 1, fact: "蛀牙菌吃糖后会\"吐酸水\"，持续侵蚀牙齿的珐琅质形成蛀洞！", difficulty: "easy", faction: "pathogen", cardId: "cavity_bacteria", type: "mechanism", principle: "mechanism", tags: ["legacy","cavity","acid_erosion"] },
  { q: "人的嘴巴里大约有多少种细菌？", options: ["10种", "70种", "700种", "7000种"], answer: 2, fact: "人的口腔里住着超过700种细菌！大部分是无害的。", difficulty: "hard", faction: "pathogen", cardId: "cavity_bacteria", type: "memorization", tags: ["legacy","cavity","oral_bacteria"] },
  { q: "为什么吃完甜食要刷牙？", options: ["让牙齿变白", "不让细菌有糖吃", "甜食有毒", "让口气清新"], answer: 1, fact: "蛀牙菌最爱吃糖！刷牙清除食物残渣，不给蛀牙菌产酸的机会。", difficulty: "easy", faction: "pathogen", cardId: "cavity_bacteria", type: "mechanism", principle: "mechanism", tags: ["legacy","cavity","hygiene"] },

  { q: "狂犬病毒感染后不打疫苗，致死率是多少？", options: ["10%", "50%", "80%", "几乎100%"], answer: 3, fact: "狂犬病一旦发病致死率几乎100%！但及时打疫苗就能预防。", difficulty: "medium", faction: "pathogen", cardId: "rabies_virus", type: "memorization", tags: ["legacy","rabies","lethality"] },
  { q: "狂犬病毒是怎么到达大脑的？", options: ["通过血液", "沿着神经爬过去", "通过淋巴", "直接穿过头骨"], answer: 1, fact: "狂犬病毒不走血液，沿着外周神经一路\"爬\"到大脑！", difficulty: "hard", faction: "pathogen", cardId: "rabies_virus", type: "mechanism", principle: "mechanism", tags: ["legacy","rabies","neural_spread"] },
  { q: "狂犬病毒为什么让动物变得爱咬人？", options: ["纯属巧合", "控制大脑让宿主有攻击性以传播病毒", "让动物肚子饿", "动物本来就爱咬人"], answer: 1, fact: "狂犬病毒感染大脑后让宿主变得暴躁爱咬人，病毒就能通过唾液传给下一个受害者——这是病毒的\"生存策略\"！", difficulty: "hard", faction: "pathogen", cardId: "rabies_virus", type: "mechanism", principle: "mechanism", tags: ["legacy","rabies","host_manipulation"] },

  { q: "大肠杆菌多久能分裂一次？", options: ["20分钟", "2小时", "1天", "1周"], answer: 0, fact: "大肠杆菌每20分钟分裂一次，8小时后理论上可以变成1700万个！", difficulty: "medium", faction: "pathogen", cardId: "ecoli_thug", type: "memorization", tags: ["legacy","ecoli","division_rate"] },
  { q: "大肠杆菌对人体一定有害吗？", options: ["全部有害", "大部分是有益的", "只在冬天有害", "只对小孩有害"], answer: 1, fact: "大部分大肠杆菌是有益的！帮你消化食物和制造维生素K。", difficulty: "easy", faction: "pathogen", cardId: "ecoli_thug", type: "memorization", principle: "coevolution", tags: ["legacy","ecoli","beneficial","microbiome"] },
  { q: "你的肠道里大约住着多少个细菌？", options: ["几百个", "几百万个", "几十亿个", "几万亿个"], answer: 3, fact: "肠道里住着大约38万亿个细菌！比你全身的人体细胞还多。", difficulty: "medium", faction: "pathogen", cardId: "ecoli_thug", type: "memorization", tags: ["legacy","ecoli","gut_flora"] },

  { q: "绦虫最长能长到多少米？", options: ["1米", "5米", "10米", "20米"], answer: 3, fact: "绦虫最长能到20米——比一辆公交车还长！", difficulty: "medium", faction: "pathogen", cardId: "tapeworm_lurker", type: "memorization", tags: ["legacy","tapeworm","length"] },
  { q: "绦虫住在人的肠子里，为什么它自己反而不需要消化系统？", options: ["肠里全是宿主消化好的养分，直接吸收就行", "因为它身体太小，根本不需要进食", "它能像植物一样自己制造养分", "它的消化系统藏在头节里没退化"], answer: 0, fact: "绦虫泡在宿主已经消化好的'营养汤'里，吸收现成的就够了——既然不缺吃的，再自己造一套消化系统反而浪费，于是绦虫干脆'省掉'了消化道！这是寄生虫的'极简生存'：环境给的，就不必自己造。", difficulty: "hard", faction: "pathogen", cardId: "tapeworm_lurker", type: "inference", principle: "tradeoff", tags: ["ch2","tapeworm","parasitism"] },

  { q: "噬菌体是什么？", options: ["一种细菌", "专门吃细菌的病毒", "一种药物", "一种白细胞"], answer: 1, fact: "噬菌体是专门感染并杀死细菌的病毒！像微型登月飞船。", difficulty: "easy", faction: "pathogen", cardId: "bacteriophage_killer", type: "memorization", tags: ["legacy","phage","definition"] },
  { q: "一个噬菌体能从一个细菌里释放多少个后代？", options: ["2个", "20个", "200个", "2000个"], answer: 2, fact: "一个细菌可以释放约200个新的噬菌体！", difficulty: "hard", faction: "pathogen", cardId: "bacteriophage_killer", type: "memorization", tags: ["legacy","phage","burst_size"] },
  { q: "噬菌体长得像什么？", options: ["圆球", "长条", "微型登月飞船", "星星"], answer: 2, fact: "噬菌体有多面体头部、管状尾巴和像脚的纤维，看起来像微型登月飞船！", difficulty: "easy", faction: "pathogen", cardId: "bacteriophage_killer", type: "memorization", tags: ["legacy","phage","morphology"] },
  { q: "科学家正在研究用噬菌体来做什么？", options: ["做食物", "代替抗生素杀菌", "发电", "做衣服"], answer: 1, fact: "科学家正在研究用噬菌体精准杀灭特定细菌，叫\"噬菌体疗法\"！", difficulty: "hard", faction: "pathogen", cardId: "bacteriophage_killer", type: "memorization", tags: ["legacy","phage","therapy"] },
  { q: "地球上数量最多的生物是什么？", options: ["蚂蚁", "细菌", "噬菌体（病毒）", "人类"], answer: 2, fact: "噬菌体是地球上数量最多的生物实体！估计有10的31次方个。", difficulty: "hard", faction: "pathogen", cardId: "bacteriophage_killer", type: "memorization", tags: ["legacy","phage","abundance"] },

  { q: "疟疾是通过什么传播的？", options: ["空气", "水", "蚊子叮咬", "食物"], answer: 2, fact: "疟原虫通过蚊子叮咬传播，钻进红细胞里\"安家\"！", difficulty: "easy", faction: "pathogen", cardId: "plasmodium_parasite", type: "memorization", tags: ["legacy","malaria","mosquito_vector"] },
  { q: "疟疾在人类历史上造成了什么影响？", options: ["没什么影响", "杀死的人比所有战争都多", "只影响了非洲", "100年前就消灭了"], answer: 1, fact: "疟疾杀死的人估计比所有战争加起来还多！至今每年仍有数十万人死于疟疾。", difficulty: "medium", faction: "pathogen", cardId: "plasmodium_parasite", type: "memorization", tags: ["legacy","malaria","history"] },

  { q: "肉毒杆菌的毒素还被用来做什么？", options: ["做饭调味", "美容除皱", "治疗感冒", "制作疫苗"], answer: 1, fact: "肉毒毒素（Botox）微量注射可以消除皱纹！用多了是毒药，用少了是药物。", difficulty: "hard", faction: "pathogen", cardId: "botulinum_chef", type: "memorization", principle: "tradeoff", tags: ["legacy","botulinum","botox"] },
  { q: "肉毒毒素比眼镜蛇毒强多少倍？", options: ["10倍", "1000倍", "一百万倍", "一样强"], answer: 2, fact: "肉毒毒素比眼镜蛇毒强约一百万倍！1克就能杀死100万人。", difficulty: "hard", faction: "pathogen", cardId: "botulinum_chef", type: "memorization", tags: ["legacy","botulinum","toxicity"] },
  { q: "肉毒毒素是怎么让肌肉麻痹的？", options: ["破坏肌肉细胞", "阻断神经信号", "让血管堵塞", "冻住细胞"], answer: 1, fact: "肉毒毒素阻断神经末梢释放乙酰胆碱，让肌肉收不到\"动\"的信号。", difficulty: "hard", faction: "pathogen", cardId: "botulinum_chef", type: "mechanism", principle: "mechanism", tags: ["legacy","botulinum","neuromuscular_block"] },

  { q: "艾滋病毒主要攻击什么细胞？", options: ["红细胞", "神经细胞", "辅助T细胞", "骨骼细胞"], answer: 2, fact: "HIV专门攻击辅助T细胞，就像小偷专门打警察！", difficulty: "medium", faction: "pathogen", cardId: "hiv_hunter", type: "memorization", tags: ["legacy","hiv","t_cell"] },
  { q: "现在有办法治疗艾滋病吗？", options: ["完全无法治疗", "有药物可以控制", "只能活一年", "吃中药就好"], answer: 1, fact: "现代抗病毒药物已经能让感染者像健康人一样生活很多年！", difficulty: "medium", faction: "pathogen", cardId: "hiv_hunter", type: "memorization", tags: ["legacy","hiv","treatment"] },

  { q: "新冠病毒为什么叫\"冠状\"病毒？", options: ["发现者姓冠", "形状像皇冠", "最先在冠县发现", "会导致冠心病"], answer: 1, fact: "表面凸起像皇冠，在电子显微镜下看起来像戴了一顶皇冠！", difficulty: "easy", faction: "pathogen", cardId: "covid_invader", type: "memorization", tags: ["legacy","covid","naming"] },
  { q: "新冠病毒用什么\"钥匙\"打开细胞的\"门锁\"？", options: ["核酸", "刺突蛋白", "外壳", "尾巴"], answer: 1, fact: "刺突蛋白与人体细胞ACE2受体结合，就像钥匙开锁一样入侵细胞！", difficulty: "hard", faction: "pathogen", cardId: "covid_invader", type: "memorization", tags: ["legacy","covid","spike_protein"] },
  { q: "mRNA疫苗是怎么对抗新冠的？", options: ["直接杀死病毒", "教身体认识刺突蛋白的样子", "增强体力", "把病毒冻住"], answer: 1, fact: "mRNA疫苗让细胞临时生产刺突蛋白\"样品\"，免疫系统学会识别后就能快速反击真病毒！", difficulty: "hard", faction: "pathogen", cardId: "covid_invader", type: "mechanism", principle: "mechanism", tags: ["legacy","covid","mrna_vaccine"] },
  { q: "新冠病毒有多小？", options: ["肉眼能看到", "显微镜能看到", "只有电子显微镜能看到", "和细菌一样大"], answer: 2, fact: "新冠病毒直径只有约0.1微米，比头发丝细1000倍！", difficulty: "easy", faction: "pathogen", cardId: "covid_invader", type: "memorization", tags: ["legacy","covid","size"] },

  // 🦠 病原系补充
  { q: "病毒有多大？", options: ["和细胞一样大", "比细菌小很多", "肉眼可见", "和红细胞一样大"], answer: 1, fact: "病毒比细菌小得多！一般只有20-300纳米，必须用电子显微镜才能看到。", difficulty: "easy", faction: "pathogen", cardId: "flu_virus", type: "memorization", tags: ["legacy","virus","size"] },
  { q: "感冒和流感是一回事吗？", options: ["是的", "不是，流感更严重", "感冒比流感严重", "一样的，叫法不同"], answer: 1, fact: "普通感冒和流感是不同的病毒引起的！流感症状更重、更危险，特别是对老人和小孩。", difficulty: "easy", faction: "pathogen", cardId: "flu_virus", type: "memorization", tags: ["legacy","flu","cold_vs_flu"] },
  { q: "细菌在什么温度下繁殖最快？", options: ["0°C", "20-40°C", "100°C", "零下10°C"], answer: 1, fact: "大部分细菌在20-40°C之间繁殖最快！这就是为什么食物不能在室温下放太久。", difficulty: "medium", faction: "pathogen", cardId: "ecoli_thug", type: "memorization", tags: ["legacy","bacteria","temperature"] },
  { q: "绦虫是怎么传播给人的？", options: ["通过空气", "通过没煮熟的肉", "通过握手", "通过蚊子"], answer: 1, fact: "绦虫主要通过吃了没有煮熟的肉类（特别是猪肉和牛肉）传播到人体！所以肉一定要煮熟。", difficulty: "easy", faction: "pathogen", cardId: "tapeworm_lurker", type: "memorization", tags: ["legacy","tapeworm","transmission"] },
  { q: "蛀牙菌最喜欢什么食物？", options: ["蔬菜", "肉", "糖和甜食", "水"], answer: 2, fact: "蛀牙菌最爱糖！它们把糖变成酸来侵蚀你的牙齿，所以少吃糖多刷牙很重要。", difficulty: "easy", faction: "pathogen", cardId: "cavity_bacteria", type: "memorization", tags: ["legacy","cavity","sugar"] },
  { q: "疟原虫在红细胞里做什么？", options: ["睡觉", "大量繁殖然后让红细胞爆炸", "帮红细胞运氧", "什么都不做"], answer: 1, fact: "疟原虫在红细胞里疯狂繁殖，把营养吃光后让红细胞\"爆炸\"，然后去入侵新的红细胞！", difficulty: "medium", faction: "pathogen", cardId: "plasmodium_parasite", type: "memorization", tags: ["legacy","malaria","rbc_cycle"] },
  { q: "人被狗咬了之后应该怎么做？", options: ["涂口水就好", "马上去医院打疫苗", "等着看会不会发病", "吃抗生素"], answer: 1, fact: "被动物咬伤后应该立刻清洗伤口并去医院打狂犬疫苗！越早打越有效。", difficulty: "easy", faction: "pathogen", cardId: "rabies_virus", type: "memorization", tags: ["legacy","rabies","first_aid"] },
  { q: "大肠杆菌能帮人体制造什么维生素？", options: ["维生素A", "维生素C", "维生素K", "维生素D"], answer: 2, fact: "肠道里的有益大肠杆菌能帮你制造维生素K，这种维生素对血液凝固很重要！", difficulty: "hard", faction: "pathogen", cardId: "ecoli_thug", type: "memorization", principle: "coevolution", tags: ["legacy","ecoli","vitamin_k"] },
  { q: "噬菌体对人体有害吗？", options: ["非常有害", "对人体无害，只杀细菌", "有时有害", "会导致感冒"], answer: 1, fact: "噬菌体对人体完全无害！它们只感染细菌，是\"细菌的天敌\"，可能是未来对抗超级细菌的希望。", difficulty: "easy", faction: "pathogen", cardId: "bacteriophage_killer", type: "memorization", tags: ["legacy","phage","safety"] },
  { q: "新冠病毒最初在哪一年被发现？", options: ["2017年", "2019年", "2020年", "2021年"], answer: 1, fact: "新冠病毒（SARS-CoV-2）最初在2019年底被发现，随后在2020年引发了全球大流行。", difficulty: "easy", faction: "pathogen", cardId: "covid_invader", type: "memorization", tags: ["legacy","covid","discovery_year"] },
  { q: "肉毒杆菌最容易在什么环境生长？", options: ["新鲜水果里", "密封的罐头等无氧环境", "干燥的沙漠", "冰箱里"], answer: 1, fact: "肉毒杆菌是厌氧菌，在密封的罐头、腊肉等缺氧环境中最容易生长！所以鼓胀的罐头绝对不能吃。", difficulty: "hard", faction: "pathogen", cardId: "botulinum_chef", type: "memorization", tags: ["legacy","botulinum","anaerobic"] },
  { q: "HIV病毒把自己的基因藏在哪里？", options: ["血液里", "宿主细胞的DNA里", "皮肤表面", "空气中"], answer: 1, fact: "HIV用逆转录酶把自己的RNA变成DNA，偷偷整合进宿主细胞的基因组里，所以极难被彻底清除！", difficulty: "hard", faction: "pathogen", cardId: "hiv_hunter", type: "memorization", tags: ["legacy","hiv","integration","retrovirus"] },

  // ============================================================
  // ⚗️ 科技系 (tech) — 44题
  // ============================================================

  { q: "创可贴是谁发明的？", options: ["爱迪生", "厄尔·迪克森", "弗莱明", "巴斯德"], answer: 1, fact: "创可贴是1920年厄尔·迪克森发明的，因为他太太总在厨房切到手！", difficulty: "medium", faction: "tech", cardId: "bandaid_helper", type: "memorization", tags: ["legacy","bandaid","inventor"] },
  { q: "创可贴是怎么帮助伤口愈合的？", options: ["涂了药水", "隔绝细菌保持湿润", "让伤口通风", "杀死细菌"], answer: 1, fact: "创可贴隔绝外界细菌并保持伤口湿润来加速愈合！", difficulty: "easy", faction: "tech", cardId: "bandaid_helper", type: "mechanism", principle: "mechanism", tags: ["legacy","bandaid","wound_healing"] },
  { q: "为什么医生说伤口保持适度湿润反而好得更快？", options: ["湿润让修复细胞更容易爬过来补伤口", "湿润能把伤口里的细菌全部淹死", "结的痂越厚伤口反而好得越快", "湿润让伤口一直流血冲走脏东西"], answer: 0, fact: "伤口边的修复细胞要'爬'过去才能把缺口补上。太干、结了硬痂，细胞爬不动；保持适度湿润，细胞顺畅迁移、长新皮，好得快也少留疤。所以现代创可贴会帮伤口保湿——'结痂=快好'其实是个误解。", difficulty: "medium", faction: "tech", cardId: "bandaid_helper", type: "mechanism", principle: "mechanism", tags: ["ch2","bandaid","moist_healing"] },
  { q: "洗手能预防疾病的原理是什么？", options: ["水有魔力", "肥皂能破坏病菌的外壳", "冲走灰尘就行", "让手变白"], answer: 1, fact: "肥皂分子能\"撕开\"病毒和细菌的脂质外壳，配合流水冲走残骸——简单却极其有效！", difficulty: "medium", faction: "tech", cardId: "bandaid_helper", type: "mechanism", principle: "mechanism", tags: ["legacy","hygiene","soap","handwashing"] },

  { q: "人发烧其实是身体在做什么？", options: ["生病了坏了", "在\"开暖气\"对抗病菌", "体温计坏了", "吃太多了"], answer: 1, fact: "发烧是免疫系统升高体温来对抗病菌，因为大部分细菌在高温下会变弱！", difficulty: "easy", faction: "tech", cardId: "thermometer_alarm", type: "mechanism", principle: "homeostasis", tags: ["legacy","fever","immune_defense"] },
  { q: "正常人体温大约是多少度？", options: ["35°C", "36.5-37°C", "38°C", "40°C"], answer: 1, fact: "正常人体温约36.5-37°C。超过37.3°C是低烧，超过38.5°C是高烧。", difficulty: "easy", faction: "tech", cardId: "thermometer_alarm", type: "memorization", tags: ["legacy","thermometer","normal_temp"] },
  { q: "最早的体温计是谁发明的？", options: ["牛顿", "伽利略", "爱迪生", "居里夫人"], answer: 1, fact: "最早的体温计原型是伽利略在1592年左右发明的，有一米多长！", difficulty: "hard", faction: "tech", cardId: "thermometer_alarm", type: "memorization", tags: ["legacy","thermometer","history"] },

  { q: "听诊器是因为什么原因被发明的？", options: ["想听心跳好玩", "医生觉得直接贴耳朵不礼貌", "军事需要", "给动物看病"], answer: 1, fact: "医生雷奈克需要听女病人心跳，直接贴耳朵太不礼貌，就卷了一筒纸当传声筒！", difficulty: "medium", faction: "tech", cardId: "stethoscope_listener", type: "memorization", tags: ["legacy","stethoscope","invention_story"] },
  { q: "听诊器是哪一年发明的？", options: ["1616年", "1716年", "1816年", "1916年"], answer: 2, fact: "听诊器由法国医生雷奈克在1816年发明，至今已有200多年历史！", difficulty: "hard", faction: "tech", cardId: "stethoscope_listener", type: "memorization", tags: ["legacy","stethoscope","year"] },

  { q: "X光是谁发现的？", options: ["爱因斯坦", "牛顿", "伦琴", "居里夫人"], answer: 2, fact: "伦琴在1895年发现X射线，获得第一届诺贝尔物理学奖！", difficulty: "medium", faction: "tech", cardId: "xray_vision", type: "memorization", tags: ["legacy","xray","roentgen"] },
  { q: "X光为什么叫\"X\"光？", options: ["发现者姓X", "形状像X", "因为不知道它是什么", "从X星球来的"], answer: 2, fact: "伦琴不知道这种射线是什么，就用代表未知数的\"X\"来命名！", difficulty: "easy", faction: "tech", cardId: "xray_vision", type: "memorization", tags: ["legacy","xray","naming"] },
  { q: "伦琴太太看到自己手的X光片时说了什么？", options: ["太酷了", "我看到了自己的死亡", "再拍一张", "这是假的"], answer: 1, fact: "伦琴太太看到X光片上的手骨和戒指时说\"我看到了自己的死亡\"！", difficulty: "medium", faction: "tech", cardId: "xray_vision", type: "memorization", tags: ["legacy","xray","anecdote"] },
  { q: "CT扫描和X光有什么区别？", options: ["没区别", "CT是多角度拍X光组合成3D图像", "CT用超声波", "X光更先进"], answer: 1, fact: "CT扫描是从身体周围多个角度拍摄X光，用计算机组合成3D图像！", difficulty: "hard", faction: "tech", cardId: "xray_vision", type: "mechanism", principle: "mechanism", tags: ["legacy","xray","ct_scan"] },

  { q: "第一个用显微镜看到细菌的人是谁？", options: ["伽利略", "牛顿", "列文虎克", "巴斯德"], answer: 2, fact: "列文虎克是荷兰布料商人，自己磨镜片做了几百台显微镜！", difficulty: "medium", faction: "tech", cardId: "microscope_eye", type: "memorization", tags: ["legacy","microscope","leeuwenhoek"] },
  { q: "列文虎克的职业是什么？", options: ["科学家", "医生", "布料商人", "教授"], answer: 2, fact: "列文虎克不是科学家而是布料商人！检查布料纤维时意外发现了微生物。", difficulty: "hard", faction: "tech", cardId: "microscope_eye", type: "memorization", tags: ["legacy","microscope","anecdote"] },
  { q: "列文虎克管他看到的微生物叫什么？", options: ["细菌", "病毒", "小动物", "微生物"], answer: 2, fact: "列文虎克把微生物叫做\"小动物\"（animalcules），因为当时还没有\"细菌\"这个词！", difficulty: "hard", faction: "tech", cardId: "microscope_eye", type: "memorization", tags: ["legacy","microscope","animalcules"] },

  { q: "在麻醉药发明之前，做手术时病人怎么办？", options: ["吃止痛药", "清醒着忍痛", "用针灸", "睡着了再做"], answer: 1, fact: "在麻醉药发明之前做手术简直像酷刑！病人只能咬住皮带或灌醉。", difficulty: "easy", faction: "tech", cardId: "anesthesia_fog", type: "memorization", tags: ["legacy","anesthesia","history"] },
  { q: "科学家完全搞清楚麻醉药的工作原理了吗？", options: ["完全搞清楚了", "还没有完全搞清楚", "不需要搞清楚", "100年前就搞清楚了"], answer: 1, fact: "到今天科学家还没完全搞清楚麻醉药为什么能让人失去意识！", difficulty: "hard", faction: "tech", cardId: "anesthesia_fog", type: "memorization", tags: ["legacy","anesthesia","mystery"] },
  { q: "现代麻醉是哪一年公开演示成功的？", options: ["1746年", "1846年", "1946年", "1646年"], answer: 1, fact: "1846年牙医莫顿公开用乙醚麻醉病人并成功拔牙，从此手术进入无痛时代！", difficulty: "hard", faction: "tech", cardId: "anesthesia_fog", type: "memorization", tags: ["legacy","anesthesia","year"] },

  { q: "青霉素是怎么被发现的？", options: ["精心实验设计的", "不小心发现的", "从植物里提取的", "从海洋中找到的"], answer: 1, fact: "弗莱明度假回来发现实验皿上霉菌周围的细菌全死了——这个\"偷懒\"的意外拯救了几亿人！", difficulty: "easy", faction: "tech", cardId: "penicillin_pioneer", type: "memorization", tags: ["legacy","penicillin","discovery_story"] },
  { q: "青霉素是怎么杀死细菌的？", options: ["毒死细菌", "破坏细菌的细胞壁", "把细菌冻死", "让细菌饿死"], answer: 1, fact: "青霉素破坏细菌的细胞壁，没有细胞壁的细菌就像没有壳的鸡蛋会裂开！", difficulty: "hard", faction: "tech", cardId: "penicillin_pioneer", type: "mechanism", principle: "mechanism", tags: ["legacy","penicillin","cell_wall"] },
  { q: "青霉素是从什么东西里发现的？", options: ["树皮", "霉菌", "海水", "泥土"], answer: 1, fact: "青霉素来自青霉菌——一种常见的霉菌！", difficulty: "easy", faction: "tech", cardId: "penicillin_pioneer", type: "memorization", tags: ["legacy","penicillin","mold"] },
  { q: "为什么很多医学发现都是\"意外\"？", options: ["科学家都很粗心", "科学需要好奇心去发现意外中的规律", "纯属巧合", "课本编的"], answer: 1, fact: "青霉素、X光、疫苗……只有有准备的头脑才能认出意外中隐藏的重大发现！", difficulty: "medium", faction: "tech", cardId: "penicillin_pioneer", type: "inference", tags: ["legacy","science","serendipity"] },

  { q: "疫苗的工作原理是什么？", options: ["直接杀死病毒", "给免疫系统做\"模拟训练\"", "增强体力", "修复受损细胞"], answer: 1, fact: "疫苗把弱化的病菌送进身体让白细胞练习打仗！", difficulty: "easy", faction: "tech", cardId: "vaccine_trainer", type: "mechanism", principle: "mechanism", tags: ["legacy","vaccine","immune_training"] },
  { q: "人类用疫苗消灭的第一种传染病是什么？", options: ["流感", "天花", "疟疾", "麻疹"], answer: 1, fact: "天花在1980年被彻底消灭，是人类消灭的第一种传染病！", difficulty: "medium", faction: "tech", cardId: "vaccine_trainer", type: "memorization", tags: ["legacy","vaccine","smallpox"] },
  { q: "谁发明了最早的疫苗？", options: ["弗莱明", "巴斯德", "爱德华·詹纳", "列文虎克"], answer: 2, fact: "英国医生爱德华·詹纳在1796年用牛痘接种预防天花，被称为\"免疫学之父\"！", difficulty: "medium", faction: "tech", cardId: "vaccine_trainer", type: "memorization", tags: ["legacy","vaccine","jenner"] },
  { q: "\"疫苗\"这个词来源于什么动物？", options: ["鸡", "牛", "马", "羊"], answer: 1, fact: "\"vaccine\"来自拉丁语\"vacca\"（牛），因为最早的疫苗是用牛痘病毒来预防天花！", difficulty: "hard", faction: "tech", cardId: "vaccine_trainer", type: "memorization", tags: ["legacy","vaccine","etymology"] },
  { q: "诺贝尔生理学或医学奖颁给最多哪个领域？", options: ["外科手术", "疫苗和传染病", "心脏研究", "癌症研究"], answer: 1, fact: "传染病和免疫学领域获诺贝尔奖次数最多，因为拯救了最多人的生命！", difficulty: "hard", faction: "tech", cardId: "vaccine_trainer", type: "memorization", tags: ["legacy","vaccine","nobel"] },

  { q: "是谁让手术变得安全的？", options: ["伽利略", "李斯特", "达芬奇", "弗莱明"], answer: 1, fact: "李斯特医生发明无菌手术，把手术致死率从近50%降到不足1%！", difficulty: "medium", faction: "tech", cardId: "scalpel_blade", type: "memorization", tags: ["legacy","surgery","lister","antisepsis"] },
  { q: "古代最快的外科医生能多快截肢？", options: ["1分钟", "28秒", "5分钟", "10分钟"], answer: 1, fact: "没有麻醉的年代最快记录是28秒完成一次截肢！因为病人太痛苦了。", difficulty: "medium", faction: "tech", cardId: "scalpel_blade", type: "memorization", tags: ["legacy","surgery","amputation_history"] },
  { q: "现在最精密的\"手术刀\"是什么？", options: ["钻石刀", "激光刀", "陶瓷刀", "超声刀"], answer: 1, fact: "激光手术刀能做到比头发丝还细的切口！", difficulty: "medium", faction: "tech", cardId: "scalpel_blade", type: "memorization", tags: ["legacy","surgery","laser"] },
  { q: "世界上第一个使用消毒的医生是谁？", options: ["弗莱明", "塞麦尔维斯", "李斯特", "詹纳"], answer: 1, fact: "匈牙利医生塞麦尔维斯1847年发现让医生洗手能大幅降低产妇死亡率，但当时几乎没人信他！", difficulty: "hard", faction: "tech", cardId: "scalpel_blade", type: "memorization", tags: ["legacy","surgery","semmelweis"] },

  { q: "为什么医生说\"不要随便吃抗生素\"？", options: ["太贵了", "味道不好", "会让细菌产生耐药性", "会让人上瘾"], answer: 2, fact: "过度使用抗生素会让细菌\"学会\"抵抗，变成\"超级细菌\"！", difficulty: "easy", faction: "tech", cardId: "antibiotic_ultimate", type: "inference", tags: ["legacy","antibiotic","resistance","overuse"] },
  { q: "\"超级细菌\"是什么意思？", options: ["特别大的细菌", "对多种抗生素都耐药的细菌", "能让人变超人的细菌", "超级有益的细菌"], answer: 1, fact: "超级细菌是对多种抗生素都产生耐药性的细菌，是21世纪最严峻的公共卫生危机之一！", difficulty: "medium", faction: "tech", cardId: "antibiotic_ultimate", type: "memorization", tags: ["legacy","antibiotic","superbug"] },
  { q: "感冒了应该吃抗生素吗？", options: ["应该", "不应该，感冒是病毒引起的", "看心情", "吃一半就行"], answer: 1, fact: "普通感冒是病毒引起的，抗生素只能杀细菌不能杀病毒！", difficulty: "easy", faction: "tech", cardId: "antibiotic_ultimate", type: "memorization", tags: ["legacy","antibiotic","cold_virus"] },

  // ⚗️ 科技系补充
  { q: "温度计里的红色液体是什么？", options: ["血液", "酒精（染了色）", "水银", "番茄酱"], answer: 1, fact: "现代温度计里的红色液体通常是染了色的酒精！以前用的水银有毒，现在很少用了。", difficulty: "easy", faction: "tech", cardId: "thermometer_alarm", type: "memorization", tags: ["legacy","thermometer","alcohol"] },
  { q: "听诊器能听到什么声音？", options: ["只能听心跳", "心跳、呼吸和肠道蠕动", "只能听说话", "什么都能听到"], answer: 1, fact: "听诊器能听到心跳、呼吸音和肠道蠕动声！医生通过这些声音来判断你的身体状况。", difficulty: "easy", faction: "tech", cardId: "stethoscope_listener", type: "memorization", tags: ["legacy","stethoscope","sounds"] },
  { q: "显微镜能放大多少倍？", options: ["2倍", "100倍", "光学显微镜可达2000倍", "无限大"], answer: 2, fact: "光学显微镜最高约2000倍，电子显微镜可达200万倍！能看到原子级别的细节。", difficulty: "medium", faction: "tech", cardId: "microscope_eye", type: "memorization", tags: ["legacy","microscope","magnification"] },
  { q: "X光对人体有害吗？", options: ["完全无害", "有微量辐射，但偶尔拍没事", "非常危险", "只对小孩有害"], answer: 1, fact: "X光有微量辐射，但偶尔拍一次完全没问题！医生会控制剂量，收益远大于风险。", difficulty: "easy", faction: "tech", cardId: "xray_vision", type: "memorization", tags: ["legacy","xray","radiation_safety"] },
  { q: "手术前为什么医生要洗手那么久？", options: ["手很脏", "消灭手上所有细菌防止感染", "医院规定", "让手变软"], answer: 1, fact: "外科手术前医生要用消毒液洗手至少3-5分钟！这叫\"外科洗手\"，能消灭99.9%的细菌。", difficulty: "easy", faction: "tech", cardId: "scalpel_blade", type: "mechanism", principle: "mechanism", tags: ["legacy","surgery","scrubbing","asepsis"] },
  { q: "世界上第一种抗生素是什么？", options: ["阿莫西林", "青霉素", "头孢", "红霉素"], answer: 1, fact: "青霉素是世界上第一种广泛使用的抗生素！1928年发现，二战中拯救了无数士兵的生命。", difficulty: "easy", faction: "tech", cardId: "penicillin_pioneer", type: "memorization", tags: ["legacy","antibiotic","penicillin"] },
  { q: "麻醉有几种类型？", options: ["只有全身麻醉", "全身麻醉和局部麻醉", "只有局部麻醉", "没有分类"], answer: 1, fact: "麻醉分为全身麻醉（完全失去意识）和局部麻醉（只是某个部位没有感觉）。拔牙打的就是局部麻醉！", difficulty: "medium", faction: "tech", cardId: "anesthesia_fog", type: "memorization", tags: ["legacy","anesthesia","types"] },
  { q: "创可贴是哪一年发明的？", options: ["1820年", "1920年", "1970年", "2000年"], answer: 1, fact: "创可贴是1920年发明的，至今已有100多年历史！是家庭急救箱里最基本的用品。", difficulty: "medium", faction: "tech", cardId: "bandaid_helper", type: "memorization", tags: ["legacy","bandaid","year"] },
  { q: "疫苗打到身体哪里？", options: ["胃里", "肌肉或皮下", "直接进血管", "涂在皮肤上"], answer: 1, fact: "大部分疫苗是注射到肌肉或皮下！这样免疫细胞能更好地接触到疫苗中的抗原并产生免疫反应。", difficulty: "easy", faction: "tech", cardId: "vaccine_trainer", type: "memorization", tags: ["legacy","vaccine","injection_site"] },
  { q: "为什么有些抗生素要\"吃完整个疗程\"？", options: ["多吃更健康", "不吃完细菌杀不干净会反弹", "医生多赚钱", "药物会过期"], answer: 1, fact: "如果抗生素没吃完就停药，残留的细菌可能是最强壮的那些——它们会繁殖出更耐药的后代！", difficulty: "medium", faction: "tech", cardId: "antibiotic_ultimate", type: "inference", tags: ["legacy","antibiotic","full_course","resistance"] },
  ...
  // ============================================================
  // ✏️ legacy 衍生原理题（老题精分类后，把暗含原理的 trivia 升级为机制/推理题）
  // ============================================================
  { q: "HIV 为什么专挑免疫系统的 T 细胞攻击，特别可怕？", options: ["因为 T 细胞数量最多最容易被感染", "因为 T 细胞跑得最慢最好追上", "T 细胞是免疫指挥官，垮了整个防御都瘫痪", "因为 T 细胞里营养最多最好吃"], answer: 2, fact: "T 细胞是免疫系统的'总指挥'——它发号施令、调动其他免疫细胞打仗。HIV 专门感染并杀死 T 细胞，等于先干掉指挥官，整支免疫部队就乱了套，连平时的小病都扛不住。这就是艾滋病'获得性免疫缺陷'的真正含义。", difficulty: "hard", faction: "pathogen", cardId: "hiv_hunter", type: "inference", principle: "mechanism", tags: ["ch2","hiv","immune_command"] },
  { q: "为什么 HIV 感染后吃药也很难把病毒彻底清除干净？", options: ["它躲在骨头深处，药物根本到不了", "它把基因藏进了人体细胞的 DNA 里", "它变异太快，药刚做好就失效了", "它每天产生太多，根本杀不完"], answer: 1, fact: "HIV 是'逆转录病毒'——它能把自己的基因偷偷写进人体细胞的 DNA 里'潜伏'起来。药物只能清除血液里活跃的病毒，却杀不掉藏在细胞基因里的'卧底'；一停药，潜伏的病毒又冒出来。所以目前只能长期控制、很难根治。", difficulty: "hard", faction: "pathogen", cardId: "hiv_hunter", type: "inference", principle: "mechanism", tags: ["ch2","hiv","latency","retrovirus"] },

  { q: "白细胞是用什么办法把入侵的细菌'消灭'掉的？", options: ["发射像子弹一样的小针扎死细菌", "缠住细菌把它勒成两半勒断", "把细菌整个吞进肚子里再消化掉", "放出电流把细菌电焦烧死"], answer: 2, fact: "白细胞里的'吞噬细胞'对付细菌简单粗暴——直接把细菌整个'吃'进去，包进小泡，再用强力消化酶溶解掉！这叫'吞噬作用'。一个吞噬细胞能一口气吃掉好几个甚至几十个细菌。", difficulty: "medium", faction: "body", cardId: "white_blood_cell", type: "mechanism", principle: "mechanism", tags: ["ch2","wbc","phagocytosis"] },
  { q: "新冠病毒是怎么打开人体细胞的'门'钻进去的？", options: ["用表面的刺突蛋白像钥匙一样配上门锁", "用尖刺直接把细胞膜戳破一个洞", "假装成营养骗细胞主动把它吃进去", "释放酸把细胞外壳腐蚀出缺口"], answer: 0, fact: "新冠病毒表面有很多'刺突蛋白'，形状正好能和人体细胞表面的'ACE2'受体严丝合缝扣上——就像钥匙配锁。配上后病毒就骗开细胞的'门'钻进去复制。疫苗和很多药就是想办法堵住这把'钥匙'。", difficulty: "hard", faction: "pathogen", cardId: "covid_invader", type: "mechanism", principle: "mechanism", tags: ["ch2","covid","spike_ace2"] },
  { q: "为什么得了疟疾会一阵一阵、有规律地发高烧？", options: ["因为蚊子每隔几天就再来咬一口", "因为白天热晚上凉来回折腾着", "因为人一紧张体温就自动升高", "疟原虫在红细胞里同时繁殖又同时撑破"], answer: 3, fact: "疟原虫钻进红细胞后会'同步'繁殖，到点又几乎同时撑破一大批红细胞、一起冲出来——身体被这波'集体爆发'刺激就发高烧。等它们再钻进新红细胞、再同步繁殖一轮，又发一次。所以疟疾发烧像闹钟一样有规律。", difficulty: "hard", faction: "pathogen", cardId: "plasmodium_parasite", type: "mechanism", principle: "mechanism", tags: ["ch2","malaria","fever_cycle"] },
  { q: "为什么蜜蜂蜇了人之后，自己反而会死掉？", options: ["蜇人用光了它一辈子所有的力气", "倒钩的刺拔不出来，把内脏一起带出来", "毒液喷完之后蜜蜂就活活饿死了", "蜂针断了它就迷路再也飞不回家"], answer: 1, fact: "蜜蜂的刺上有倒钩，扎进人皮肤后拔不出来。蜜蜂硬飞走时，会把刺连同一部分内脏一起扯下来，因此很快死去。这是'以命防御'的取舍：用自己的命换一次有力警告，保护整个蜂群。", difficulty: "medium", faction: "nature", cardId: "bee_worker", type: "mechanism", principle: "tradeoff", tags: ["ch3","bee","barbed_stinger"] },
  { q: "猎豹明明跑得最快，为什么追猎物追一会儿就得停下来？", options: ["它一跑起来就忘了猎物在哪", "它的腿最多只能连续跑三步", "全速冲刺身体太热，再跑会中暑", "它跑得太快了就看不清路"], answer: 2, fact: "猎豹靠爆发力冲到时速 120 公里，但全速奔跑让体温飙升极快——约 30 秒就逼近危险高温，必须停下散热，否则会中暑。这是'速度'换来的代价：跑得最快，却跑不久。所以猎豹得靠偷偷接近、一击定胜负。", difficulty: "medium", faction: "nature", cardId: "cheetah_sprinter", type: "mechanism", principle: "tradeoff", tags: ["ch3","cheetah","overheating"] },
  { q: "蓝鲸深潜时，心跳为什么会慢到每分钟才几下？", options: ["心跳放慢能省着用氧气，在水下待更久", "因为深海太冷把心脏冻得跳不动", "因为水压太大把心脏压得跳不快", "因为深处太黑蓝鲸就睡着了"], answer: 0, fact: "蓝鲸一个猛子扎到深海好几百米，没法换气。它会主动把心跳降到每分钟才 2 下，让身体'慢下来'、省着用储存的氧气，就能在水下待更久。这是身体自动调节维持平衡的本事——叫'潜水反射'。", difficulty: "hard", faction: "nature", cardId: "blue_whale_titan", type: "mechanism", principle: "homeostasis", tags: ["ch3","blue_whale","dive_reflex"] },
  { q: "为什么科学家说肠道里的大肠杆菌大多对人'有益'？", options: ["它们能替人体直接消灭所有病毒", "它们会在肠道里发光帮忙照明", "它们能帮人多长出好几颗牙", "它们帮人消化、造维生素，还挤走坏菌"], answer: 3, fact: "肠道里的'好'大肠杆菌帮我们分解食物、合成维生素 K，还占住地盘抢走营养，让有害菌没机会大量繁殖。我们给它们住和吃，它们帮我们干活——这是人和肠道菌的互利共生。只有少数特殊菌株才致病。", difficulty: "medium", faction: "pathogen", cardId: "ecoli_thug", type: "mechanism", principle: "coevolution", tags: ["ch2","ecoli","gut_symbiosis"] },
  { q: "肉毒素是最毒的毒素之一，为什么医生还敢用它来美容除皱？", options: ["美容用的是另一种没毒的假肉毒素", "用极微小的量，少到只麻痹局部小肌肉", "涂在皮肤外面毒进不到身体里", "加热之后它的毒性就完全消失"], answer: 1, fact: "同一种东西是毒药还是良药，往往看'剂量'。肉毒素量大能致命，但医生用极微小的量、精准打进特定小肌肉，只让那块肌肉放松，皱纹就舒展了。剂量决定一切——这是毒理学最重要的一句话。", difficulty: "hard", faction: "pathogen", cardId: "botulinum_chef", type: "mechanism", principle: "tradeoff", tags: ["ch2","botulinum","dose_response"] },

  // ============================================================
  // ✏️ 三层补全（10 张纯记忆卡补机制/推理 + sp_gaia 建题），让 137 卡全部三层齐全
  // ============================================================
  { q: "水母没有大脑，靠什么感知周围、做出反应？", options: ["靠一个藏在伞顶里的小型大脑", "靠遍布全身的简单神经网感知和反应", "靠眼睛看清楚之后再做决定", "靠和身边的同伴商量着行动"], answer: 1, fact: "水母没有集中的大脑，但全身布着一张'神经网'——感觉到光、触碰或猎物，神经网就近传信号、直接指挥伞盖收缩或刺细胞发射。没有指挥中心照样能反应，这种古老又简单的设计让水母活了 6 亿多年。", difficulty: "medium", faction: "nature", cardId: "jellyfish_stealth", type: "mechanism", principle: "mechanism", tags: ["ch3","jellyfish","nerve_net"] },
  { q: "向日葵幼苗追着太阳转，根本目的是为了什么？", options: ["让花盘看起来更漂亮来吸引蜜蜂", "跟着太阳取暖不让自己冻着", "多晒太阳，好用光合作用造更多养分", "把靠近的害虫都晒得不敢来"], answer: 2, fact: "向日葵追着太阳转，是为了让叶子和花盘尽量多接收阳光——阳光越多，光合作用就能造出越多的糖（养分）。植物用阳光+水+二氧化碳自己造食物，这是地球上几乎所有生命的能量起点。", difficulty: "medium", faction: "nature", cardId: "sunflower_charger", type: "mechanism", principle: "mechanism", tags: ["ch3","sunflower","photosynthesis"] },
  { q: "电鳗住在浑浊看不清的亚马逊河里，靠什么'看'路和找猎物？", options: ["靠一双超级明亮的大眼看穿浑水", "靠像蝙蝠那样发出超声波探路", "靠灵敏的鼻子闻出东西的位置", "放出微弱电场，靠电场变化感知周围"], answer: 3, fact: "河水浑浊得几乎看不见，电鳗就放出微弱电脉冲在身边形成'电场'。任何东西靠近都会扰动电场，电鳗一感觉到变化就知道哪里有猎物或障碍——相当于用电'看'世界。捕猎时再放大电击把猎物麻翻。", difficulty: "medium", faction: "nature", cardId: "electric_eel_battery", type: "mechanism", principle: "mechanism", tags: ["ch3","electric_eel","electrolocation"] },
  { q: "划破手指后，血为什么过一会儿能自己止住？", options: ["血小板冲到伤口聚成团，堵住破洞", "血液一遇到空气就自动变成固体", "皮肤会立刻长好把整个伤口盖住", "身体把那根血管彻底关掉不供血"], answer: 0, fact: "一划破，血小板就成群冲到伤口，互相'手拉手'黏在一起堵住破口，还拉来纤维织成网把血细胞兜住，慢慢结成血块止血。所以小伤口过会儿就不流了——是血小板这群'小工人'在抢修。", difficulty: "medium", faction: "body", cardId: "platelet_guardian", type: "mechanism", principle: "mechanism", tags: ["ch2","platelet","clotting"] },
  { q: "神经元之间传递消息那么快，靠的是什么方式？", options: ["靠血液把消息一点点运过去", "像电流一样沿神经纤维飞快传电信号", "靠一个个神经元爬过去报信", "靠大声喊话让消息传出去"], answer: 1, fact: "神经元传消息靠'电信号'——像电流一样沿着细长的神经纤维飞快窜过去，比血液运输快几百倍；到末梢再用化学物质把信号交给下一个神经元。所以你一碰到烫的，手几乎瞬间就缩回来。", difficulty: "medium", faction: "body", cardId: "neuron_messenger", type: "mechanism", principle: "mechanism", tags: ["ch2","neuron","electrical_signal"] },
  { q: "抗体为什么一种只能对付一种病菌，不能通吃？", options: ["它每次用完就坏掉只能打一种", "它被规定一辈子只准打一种病菌", "它的形状只和一种病菌严丝合缝咬合", "它太小了一次只抓得住一个"], answer: 2, fact: "抗体的'手'有特定形状，只能和某一种病菌表面的分子像钥匙配锁一样咬合，所以一种抗体只认一种敌人。好在身体能造出超过 10 亿种不同形状的抗体，几乎任何入侵者都有对应的那把'锁'。", difficulty: "medium", faction: "body", cardId: "antibody_missile", type: "mechanism", principle: "mechanism", tags: ["ch2","antibody","specificity"] },
  { q: "噬菌体是怎么把一个细菌变成'噬菌体工厂'的？", options: ["钻进细菌肚子里慢慢把它吃掉", "缠住细菌让它喘不上气憋死", "给细菌喂下毒药让它生病死掉", "把基因注射进细菌，逼它造噬菌体"], answer: 3, fact: "噬菌体落在细菌上，像打针一样把自己的基因注射进去，细菌的'生产线'被劫持，开始照着噬菌体的基因疯狂制造新噬菌体，造满后细菌'砰'地裂开，放出几百个噬菌体宝宝去感染下一个细菌。", difficulty: "medium", faction: "pathogen", cardId: "bacteriophage_killer", type: "mechanism", principle: "mechanism", tags: ["ch2","phage","injection_replication"] },
  { q: "医生靠听诊器'听'声音，为什么就能判断病情？", options: ["器官生病时声音会变，能听出异常", "声音能直接杀死身体里的病菌", "听一听就能让病人放松不紧张", "声音越大就说明病得越严重"], answer: 0, fact: "心、肺、肠在健康和生病时发出的声音不一样——肺部感染会有'湿啰音'，心脏瓣膜出问题会有杂音。医生用听诊器放大体内声音，从声音变化判断哪里出了问题，相当于给身体做'声音体检'。", difficulty: "medium", faction: "tech", cardId: "stethoscope_listener", type: "mechanism", principle: "mechanism", tags: ["ch2","stethoscope","diagnosis"] },
  { q: "显微镜的发明，为什么对'打败传染病'特别重要？", options: ["显微镜发出的光能直接照死病菌", "先看见细菌病毒，才知道病是谁引起的", "经常看显微镜能让医生眼睛更厉害", "显微镜能把病人放大了再治疗"], answer: 1, fact: "在显微镜之前，人们生病只能归咎于'瘴气''天谴'，不知道真凶。显微镜让人类第一次看见细菌和病毒——知道了敌人长什么样、从哪来，才有了消毒、疫苗、抗生素。看得见，才打得赢。", difficulty: "hard", faction: "tech", cardId: "microscope_eye", type: "inference", tags: ["ch2","microscope","germ_discovery"] },
  { q: "麻醉药的出现，为什么让外科手术发生了翻天覆地的变化？", options: ["麻醉药能直接把病治好不用再开刀", "麻醉药能让手术的伤口自己愈合", "病人不痛了，医生能从容做复杂手术", "麻醉能让手术速度直接快一百倍"], answer: 2, fact: "麻醉药之前，手术全靠病人硬扛剧痛，医生只能拼速度（最快 28 秒截肢！），没法做精细、长时间的手术。麻醉让病人安睡无痛后，医生终于能从容做开胸、开颅这类复杂手术——现代外科才真正开始。", difficulty: "hard", faction: "tech", cardId: "anesthesia_fog", type: "inference", tags: ["ch2","anesthesia","painless_surgery"] },
  { q: "1995 年黄石公园重新请回了哪种动物，让整片山谷'活'了过来？", options: ["大象", "熊猫", "老虎", "灰狼"], answer: 3, fact: "1995 年黄石公园重新引入了灰狼。狼控制了鹿群、河岸植物长回来、河狸和鸟类也回来了——整片山谷重新焕发生机。这说明一个'关键物种'能牵动整个生态系统。", difficulty: "easy", faction: "nature", cardId: "sp_gaia_restoration", type: "memorization", tags: ["ch3","rewilding","wolf"] },
  { q: "海獭一回到海里，海带森林就重新长起来了——这是怎么做到的？", options: ["海獭吃海胆，海胆少了海带就不被啃光", "海獭会亲自用手种下海带的苗", "海獭的粪便正好是海带的肥料", "海獭把周围的海水搅得更干净"], answer: 0, fact: "海胆爱啃海带，海獭爱吃海胆——海獭一回来，海胆被压下去，海带森林就不再被啃光、重新茂盛，又养活鱼虾等生物。一个物种通过'食物链'牵动整片生态，这叫关键物种效应。", difficulty: "medium", faction: "nature", cardId: "sp_gaia_restoration", type: "mechanism", principle: "mechanism", tags: ["ch3","otter","kelp_forest"] },
  { q: "为什么科学家说'守护一只关键物种，等于守护一整个生态系统'？", options: ["因为它是体型最大最强壮的动物", "它通过食物链牵动许多其他物种的存亡", "因为它能自己制造氧气给大家用", "因为它会主动保护其他所有动物"], answer: 1, fact: "关键物种像生态系统的'拱心石'——海獭、灰狼这样的物种通过食物链牵着一大串其他生物：它在，系统平衡运转；它没了，可能一连串物种跟着崩溃。所以保护它一个，等于护住一整片生态。", difficulty: "hard", faction: "nature", cardId: "sp_gaia_restoration", type: "inference", principle: "coevolution", tags: ["ch3","keystone_species","ecosystem"] },

  // ============================================================
  // 🌊🔬 Phase 2 能量主线扩卡题（深海管虫/蓝细菌/叶绿体/眼虫）
  // ============================================================
  { q: "深海管虫住在哪种太阳照不到的地方？", options: ["阳光充足的海面珊瑚礁里", "海底会喷硫化氢的热泉附近", "温暖明亮的沙滩浅水里", "有水草的淡水河流和湖里"], answer: 1, fact: "深海管虫住在两千多米深的海底'热泉'旁——那里太阳光完全照不到，海底裂缝喷出滚烫、富含硫化氢的热水。", difficulty: "easy", faction: "nature", cardId: "tube_worm_vent", type: "memorization", tags: ["ch3","tube_worm","deep_sea"] },
  { q: "深海管虫没有嘴也没有肚子，怎么吃饱的？", options: ["张开红色羽冠直接捞海里小鱼", "靠脚上的吸盘吸食海底的泥沙", "靠体内住的细菌用化学能造食物喂它", "趁晚上爬出去偷吃别的生物"], answer: 2, fact: "深海管虫成体没有嘴和消化道，全靠体内共生细菌用硫化氢的化学能把空气里的二氧化碳造成食物喂给它；管虫则用红色羽冠从海水吸收硫化氢和氧气运给细菌——谁也离不开谁。", difficulty: "medium", faction: "nature", cardId: "tube_worm_vent", type: "mechanism", principle: "mechanism", tags: ["ch3","tube_worm","chemosynthesis"] },
  { q: "深海管虫一辈子见不到阳光却活得很好，说明什么？", options: ["生命的能量不一定来自太阳，化学能也行", "它其实偷偷储存了很多阳光备用", "它根本不需要任何能量就能活", "深海里其实藏着看不见的阳光"], answer: 0, fact: "我们常说'万物生长靠太阳'——植物靠光合作用把阳光变食物。但深海管虫靠'化能合成'，用化学能造食物，完全不要阳光。能量的源头不止太阳一种，这刷新了科学家对'生命需要什么'的认识！", difficulty: "hard", faction: "nature", cardId: "tube_worm_vent", type: "inference", principle: "mechanism", tags: ["ch3","tube_worm","chemosynthesis","chemoautotroph"] },
  { q: "蓝细菌是地球上最早会做什么事的生物？", options: ["产氧光合作用", "在陆地上行走", "捕食其他动物", "用骨骼支撑身体"], answer: 0, fact: "蓝细菌很早就会'产氧光合作用'：用阳光、水和二氧化碳造糖，同时放出氧气。它是地球上最早会产氧的生物。", difficulty: "easy", faction: "nature", cardId: "cyanobacteria_oxygen", type: "memorization", tags: ["ch3","cyanobacteria","photosynthesis"] },
  { q: "植物绿叶里负责光合作用的'叶绿体'，最早是从哪里来的？", options: ["植物从泥土里直接吸出来长成的", "由细胞核分裂出去变成的", "被大细胞吞下却没消化的蓝细菌", "阳光照在叶子上慢慢凝结成的"], answer: 2, fact: "很久以前一个大细胞吞下蓝细菌却没消化它，蓝细菌住下来变成了叶绿体——这叫'内共生'，和线粒体一样都是被吞下的细菌。所以今天每片绿叶里都藏着蓝细菌的后代！", difficulty: "medium", faction: "nature", cardId: "cyanobacteria_oxygen", type: "mechanism", principle: "coevolution", tags: ["ch3","cyanobacteria","endosymbiosis"] },
  { q: "蓝细菌出现之前空气里几乎没有氧气，那为什么说是它让动物成为可能？", options: ["它直接进化成了第一批小动物", "它放出氧气，让靠呼吸的生物得以出现", "它先教会别的生物呼吸氧气", "它让海水变咸适合动物生活"], answer: 1, fact: "蓝细菌很早就会产氧，但氧气过了很久（到约24亿年前的大氧化事件）才在大气里积累起来，之后才可能进化出需要呼吸的动物。靠呼吸氧气获得能量的生物能爆发出更大的力量——能量从哪来，决定了谁能活下来。", difficulty: "hard", faction: "nature", cardId: "cyanobacteria_oxygen", type: "inference", principle: "mechanism", tags: ["ch3","cyanobacteria","great_oxidation"] },
  { q: "叶绿体靠什么把阳光变成养分？", options: ["叶绿素", "蜡笔", "颜料", "白糖"], answer: 0, fact: "叶绿体里的绿色色素叫叶绿素，它能抓住阳光的能量，启动光合作用，把阳光+水+二氧化碳变成糖和氧气。植物是绿色的，正是因为叶绿素。", difficulty: "easy", faction: "nature", cardId: "chloroplast_solar_forge", type: "memorization", tags: ["ch3","photosynthesis","chlorophyll"] },
  { q: "叶绿体能做、而线粒体做不到的事是什么？", options: ["用阳光把二氧化碳造成糖", "把糖烧掉释放出能量", "保留自己的一份 DNA", "住在细胞里一起干活"], answer: 0, fact: "叶绿体会光合作用（自养）：用阳光把二氧化碳和水造成糖。线粒体不会光合，它的活是把糖'烧掉'放出能量。两者都保留自己的 DNA、都靠内共生住进细胞——但只有叶绿体能用阳光造糖。", difficulty: "medium", faction: "nature", cardId: "chloroplast_solar_forge", type: "mechanism", principle: "coevolution", tags: ["ch3","endosymbiosis","autotroph"] },
  { q: "为什么说叶绿体是几乎所有食物链的能量起点？", options: ["因为它能直接喂饱所有动物", "因为它造出的氧气是动物的食物", "因为动物体内也长着很多叶绿体", "因为只有它能把阳光固定成糖供别人吃"], answer: 3, fact: "动物（异养）不能自己造食物，只能吃别的生物。能把太阳能固定成糖的，是植物和藻类的叶绿体（自养）。羊吃草、狼吃羊，能量层层往上传，源头都是叶绿体那一步光合作用——所以它是食物链的能量起点。", difficulty: "hard", faction: "nature", cardId: "chloroplast_solar_forge", type: "inference", principle: "mechanism", tags: ["ch3","food_chain","autotroph"] },
  { q: "眼虫身体里有叶绿体，有阳光时它靠什么活着？", options: ["甩动鞭毛去追捕小猎物吃", "光合作用，自己造出食物来", "像植物一样靠根从土里吸养分", "一动不动靠喝水就能活"], answer: 1, fact: "眼虫体内有叶绿体，有光时就像植物一样进行光合作用，用阳光+水+二氧化碳自己造出糖来供自己用——这就是'自养'，不用吃别的生物也能活。眼虫没有根，这点和植物不同。游戏里它'晒太阳回血'就是在演这件事。", difficulty: "easy", faction: "nature", cardId: "euglena", type: "memorization", tags: ["ch3","euglena","photosynthesis"] },
  { q: "天黑没了阳光，眼虫为什么还能继续活下去？", options: ["它把叶绿体当电池存了一夜的电", "它会立刻睡过去等天亮再说", "它切换成异养，吸收水里的养分", "它能在黑暗里继续光合作用"], answer: 2, fact: "没光时光合作用停了，眼虫就切换成'异养'模式：甩动长鞭毛游过去，吸收水中溶解的有机养分、也能吞下小颗粒当饭吃。能自养又能异养，两条路都走得通——这正是它在游戏里'缺光开饭'技能的来历。", difficulty: "medium", faction: "nature", cardId: "euglena", type: "mechanism", principle: "mechanism", tags: ["ch3","euglena","heterotrophy"] },
  { q: "植物只会自养、动物只会异养，为什么科学家偏偏拿眼虫当'活教材'？", options: ["它是已知最小的单细胞生物", "它游得比所有微生物都要快", "它自养异养都会，正好卡在分界上", "它能在完全没水的地方也活下来"], answer: 2, fact: "'能量从哪来'是生命最根本的分界：自养自己造食物，异养靠吃别人。大多数生物只会其中一种，眼虫却两样都行——有光自养、没光异养。它正好站在这条大分界线上，所以是讲'生命怎么获取能量'最好的活教材。", difficulty: "hard", faction: "nature", cardId: "euglena", type: "inference", principle: "tradeoff", tags: ["ch3","euglena","autotroph_heterotroph"] },

  // ============================================================
  // 🌊🔬 Phase 2 第二批扩卡题（安康鱼/抹香鲸/小丑鱼/海星/帝企鹅/黏菌/硅藻/水熊虫）
  // ============================================================
  { q: "安康鱼头顶那盏小灯笼的光，到底是怎么发出来的？", options: ["靠头顶的灯泡通上电发光", "靠住在灯笼里的细菌发光", "靠反射海面照下来的阳光", "靠身体快速摩擦生热发光"], answer: 1, fact: "安康鱼自己不会发光，它头顶小灯笼里住着一群会发光的共生细菌。鱼给细菌住处和养分，细菌帮鱼发光引来猎物，这是互相帮忙的共生。深海两千米一点阳光都照不到，所以光绝不是反射阳光来的。", difficulty: "easy", faction: "nature", cardId: "anglerfish", type: "memorization", tags: ["ch3","anglerfish","bioluminescence"] },
  { q: "安康鱼明明是埋伏型猎手，为什么游戏里给它守护、让敌人只能打它？", options: ["因为发光灯笼把猎物的目光全引了过来", "因为它的体型在深海里数一数二的庞大", "因为它游得最快可以拦住所有的敌人", "因为它身上长着坚硬的骨甲挡住攻击"], answer: 0, fact: "在漆黑深海里，那点灯光是唯一的亮点，好奇的小鱼会忍不住朝它游过去——注意力全被灯吸走了。游戏用守护来表现这种把目光全引到自己身上的诱饵效果，而不是靠体型或速度。", difficulty: "medium", faction: "nature", cardId: "anglerfish", type: "mechanism", principle: "mechanism", tags: ["ch3","anglerfish","lure"] },
  { q: "安康鱼怎样让头顶的小灯笼像开关一样一闪一闪？", options: ["靠控制送给灯笼细菌的氧气多少", "靠把灯笼缩进身体里再伸出来", "靠不停地左右快速甩动小灯笼", "靠往灯笼里吐出更多发光的墨汁"], answer: 0, fact: "灯笼里的细菌发光需要氧气。安康鱼能控制送给灯笼的氧气多少：氧气多就亮，氧气少就暗，于是灯就像被开关控制一样一闪一闪，既能引猎物又能省力气。", difficulty: "hard", faction: "nature", cardId: "anglerfish", type: "mechanism", principle: "mechanism", tags: ["ch3","anglerfish","light_control"] },
  { q: "抹香鲸是潜得最深的哺乳动物，它一口气能潜到多深去捕猎？", options: ["大约 50 米深的浅海", "大约 200 米的礁石区", "超过 2000 米的深海", "只在海面附近活动"], answer: 2, fact: "抹香鲸是潜得最深的哺乳动物，能一口气下潜超过 2000 米（最深记录约 2250 米），屏息约 90 分钟，到漆黑的深海里猎杀大王乌贼。", difficulty: "easy", faction: "nature", cardId: "sperm_whale", type: "memorization", tags: ["ch3","sperm_whale","deep_sea"] },
  { q: "深海一片漆黑，抹香鲸看不见东西，它怎么找到并锁定大王乌贼？", options: ["靠一对夜视眼在黑暗里看清乌贼", "靠发出'咔哒'声听回声定位猎物", "靠灵敏鼻子闻出乌贼的气味", "靠身上发光把猎物照亮看清"], answer: 1, fact: "深海漆黑什么都看不见，抹香鲸靠头部发出'咔哒'声——这是动物界最响的声音，比喷气式飞机起飞还响——声音碰到猎物弹回来，它就听回声判断乌贼在哪、有多远，这叫回声定位。", difficulty: "medium", faction: "nature", cardId: "sperm_whale", type: "mechanism", principle: "mechanism", tags: ["ch3","sperm_whale","echolocation"] },
  { q: "抹香鲸潜到深海后没法呼吸，为什么它越省着用氧气，对捕猎反而越有利？", options: ["深海里的氧气会自己慢慢变多用不完", "海水越深氧气就越浓所以不必节省", "下潜时它能边游泳边换气补充氧气", "省下的氧气越多就能在深海待得越久猎得越多"], answer: 3, fact: "潜进深海就没法呼吸了，带下去的氧气是有限的。抹香鲸像带了很多小氧气罐，还放慢心跳、把氧气优先送给大脑和心脏来省氧。省得越多，就能在深海待得越久、猎到越多的乌贼——氧气怎么分配，决定了它能潜多深、待多久。", difficulty: "hard", faction: "nature", cardId: "sperm_whale", type: "inference", principle: "tradeoff", tags: ["ch3","sperm_whale","diving_physiology"] },
  { q: "小丑鱼躲在海葵的触手里，主要是为了得到什么？", options: ["海葵触手的保护，天敌不敢追进来", "海葵触手上甜甜的花蜜当点心", "比海里别的地方更暖和的水温", "海葵帮它照看刚生下的鱼宝宝"], answer: 0, fact: "海葵的触手上长满会射毒针的刺细胞，别的鱼一碰就被蜇。小丑鱼躲在里面，天敌不敢追进去——等于有了一座带刺的安全屋。", difficulty: "easy", faction: "nature", cardId: "clownfish_anemone", type: "memorization", tags: ["ch3","fish","symbiosis"] },
  { q: "别的鱼一碰海葵就被蜇，为什么小丑鱼钻进触手却没事？", options: ["小丑鱼游得太快，毒针根本射不中它", "身上厚黏液让海葵把它当'自家人'不发射", "它的鳞片像盔甲，能挡住所有毒针", "海葵的毒针对个子小的鱼通通没有用"], answer: 1, fact: "小丑鱼体表裹着一层特别厚的黏液（比普通鱼厚 3-4 倍，可能还会沾上海葵的黏液当'通行证'），海葵的刺细胞就把它当自家组织、不发射毒针。不是躲得快，是'化学暗号'对上了。", difficulty: "medium", faction: "nature", cardId: "clownfish_anemone", type: "mechanism", principle: "mechanism", tags: ["ch3","mucus","nematocyst"] },
  { q: "海葵不会动也不追猎物，小丑鱼住进来后它得到了什么好处？", options: ["小丑鱼会替它晒太阳造出食物", "小丑鱼背着它游去更有食物的地方", "海葵其实没好处，只是被白住而已", "赶走啃触手的鱼、清理、施肥、带来食物"], answer: 3, fact: "这不是单方面占便宜，而是互利共生：小丑鱼帮海葵赶走专啃触手的蝴蝶鱼、清理垃圾、用粪便当肥料、游动带来氧气和食物碎屑。一个出'房子'，一个出'打扫和保安'，谁也离不开谁。", difficulty: "hard", faction: "nature", cardId: "clownfish_anemone", type: "inference", principle: "coevolution", tags: ["ch3","mutualism","anemone"] },
  { q: "海星断掉一条腕后会怎样？", options: ["断腕处能慢慢重新长出一条新腕", "那条腕会永远缺一块再也长不回来", "它会立刻死掉沉到海底再也不动", "剩下的几条腕会全部一起脱落掉"], answer: 0, fact: "海星的再生力惊人：断掉一条腕，过一段时间能在断口重新长出一条新腕。更神奇的是，如果断下的腕还带着一小块中央的身体，这条腕甚至能独自长成一整只全新的海星！", difficulty: "easy", faction: "nature", cardId: "sea_star", type: "memorization", tags: ["ch3","sea_star","regeneration"] },
  { q: "海星吃藏在硬壳里的贝类，靠的是什么本事？", options: ["用尖牙把厚厚的贝壳直接嚼碎吞下", "把胃翻出体外，伸进壳缝就地消化", "先吐出毒液把贝类麻倒再整个吞下", "把贝壳搬回洞里泡软几天再慢慢吃"], answer: 1, fact: "海星没有能咬碎贝壳的大嘴，它的办法很特别：把胃从嘴里翻出体外，塞进贝壳张开的一条细缝里，就地把猎物消化成糊，再把养分吸回身体——这叫'体外消化'。游戏里它'翻胃消化'击杀后回血，演的就是这件事。", difficulty: "medium", faction: "nature", cardId: "sea_star", type: "mechanism", principle: "mechanism", tags: ["ch3","sea_star","extraoral_digestion"] },
  { q: "海星没有大脑、动作又慢，为什么还能在海底活得很稳？", options: ["它其实游得比鱼还快只是平时装慢", "它身上长着硬壳所以谁都咬不动它", "它靠藏在身体中央的一颗大脑指挥", "它靠超强再生和体外消化，慢也耐打"], answer: 3, fact: "海星走'另一条生存路线'：不拼速度和大脑，而是拼'耐打'。被咬掉一条腕能长回来、甚至重生成新海星；遇到硬壳猎物就把胃翻出去慢慢消化。再生力和体外消化让它就算慢、就算简单，也能稳稳活下去——这是一种用'恢复'代替'速度'的取舍。", difficulty: "hard", faction: "nature", cardId: "sea_star", type: "inference", principle: "tradeoff", tags: ["ch3","sea_star","survival_strategy"] },
  { q: "南极严冬里，帝企鹅靠什么办法熬过零下几十度的寒冷？", options: ["钻进深深的冰洞里舒服冬眠", "成百上千只挤成一团抱团取暖", "全都飞到温暖的南方去过冬", "靠厚厚的脂肪一动不动死扛"], answer: 1, fact: "南极冬天冷到零下几十度，成百上千只帝企鹅会紧紧挤成一团'抱团取暖'，挤在最里面的地方温度能升到约 37℃。企鹅不会飞，也不冬眠，靠的就是大家挤在一起互相取暖。", difficulty: "easy", faction: "nature", cardId: "emperor_penguin", type: "memorization", tags: ["ch3","emperor_penguin","huddle"] },
  { q: "抱团取暖时，为什么帝企鹅们要不停地往里挤、轮流换位置？", options: ["中间太挤了得轮流出来透气", "它们只是在原地踏步活动身体", "谁站中间谁就当上企鹅头领", "外圈最冷轮流换到内圈才都暖"], answer: 3, fact: "抱团时外圈最冷、内圈最暖（温度能到约37℃）。帝企鹅会不停往里挤、轮流换到中间取暖，所以没有谁被一直冻在最外面——靠轮换，整群企鹅都能熬过严冬。这就是它'轮流取暖'技能的来历。", difficulty: "medium", faction: "nature", cardId: "emperor_penguin", type: "mechanism", principle: "homeostasis", tags: ["ch3","emperor_penguin","huddle"] },
  { q: "企鹅爸爸孵蛋时差不多四个月不吃饭、体重掉一半，这说明动物育幼有什么代价？", options: ["公企鹅会偷偷溜去海里吃几口", "孵蛋主要靠体温几乎不耗能量", "养育后代要付出很大能量代价", "雄性天生就比雌性更扛饿不怕"], answer: 2, fact: "妈妈下蛋后去海里捕食，爸爸把蛋放脚背上、站在风雪里孵蛋，约四个月不进食，体重掉掉一半。养育后代要消耗大量储存的能量——这是动物为繁衍后代付出的真实代价，能量花在哪、就要在别处省下来。", difficulty: "hard", faction: "nature", cardId: "emperor_penguin", type: "inference", principle: "tradeoff", tags: ["ch3","emperor_penguin","parental_care"] },
  { q: "黏菌到底是哪一类生物？", options: ["它是一种会开花的小植物", "它是变形虫那一类的小生物", "它是一种很小的小昆虫", "它是一种长在地上的青苔"], answer: 1, fact: "黏菌既不是动物，也不是真正的真菌，而是一团会爬行的'变形虫'类小生物（原生生物）。它能像变形虫一样改变形状、缓缓移动着去找食物。", difficulty: "easy", faction: "nature", cardId: "slime_mold", type: "memorization", tags: ["ch3","slime_mold","protist"] },
  { q: "黏菌连一个脑细胞都没有，却能在迷宫里找到通往食物的最短路线，靠的是什么办法？", options: ["靠脑子先想好再选最近的那条路", "靠眼睛看清整个迷宫的全貌", "随机乱爬，运气好才碰对路线", "哪条管道流量大就长粗、没用的就缩掉"], answer: 3, fact: "黏菌会铺开很多条管道试探，'哪条路通往食物、流量大，就让它变粗加强；没用的方向就慢慢缩掉'。靠这条简单规则反复试错，没有大脑也能把路线收成最短的一条。游戏里'觅食网络'就是在演这件事。", difficulty: "medium", faction: "nature", cardId: "slime_mold", type: "mechanism", principle: "mechanism", tags: ["ch3","slime_mold","maze"] },
  { q: "黏菌没有大脑却能'解题'，科学家为什么觉得这件事很重要？", options: ["说明黏菌其实偷偷藏着一个小脑子", "说明它比人类工程师更会算数", "说明聪明地解决问题不一定非要有大脑", "说明它能看懂人类画的地图"], answer: 2, fact: "科学家在地图上按东京周边城市摆好燕麦片，黏菌长出的网络竟和工程师花几十年设计的东京地铁网一样好用。没有脑、没有神经也能找出最聪明的走法——原来不用脑子，靠一条简单的笨办法反复试，也能找出聪明的走法。这逼着科学家重新想：'聪明'到底需不需要一个大脑？", difficulty: "hard", faction: "nature", cardId: "slime_mold", type: "inference", principle: "mechanism", tags: ["ch3","slime_mold","tokyo_rail","intelligence"] },
  { q: "硅藻给自己造的'盒子'外壳，是用什么材料做的？", options: ["二氧化硅，玻璃的成分", "薄薄一层软软的外皮", "和贝壳一样的钙质硬壳", "硬邦邦的木头一样纤维"], answer: 0, fact: "硅藻用二氧化硅——也就是玻璃和沙子的成分——给自己做了一身精致的几何外壳，叫'硅壳'。它又硬又轻又透明，能挡住想吃它的小动物，还能挡紫外线。所以游戏里它'玻璃铠甲'出场就给自己套一层护盾。", difficulty: "easy", faction: "nature", cardId: "diatom", type: "memorization", tags: ["ch3","diatom","silica"] },
  { q: "硅藻又不会动、又不咬'敌人'，它那身玻璃外壳到底是怎么保护它的？", options: ["它能放电，把想吃它的小动物电晕", "它分泌毒液，毒死靠近它的天敌", "硬透明硅壳，挡咬它的还挡紫外线", "它突然变色，躲起来让谁都找不到"], answer: 2, fact: "硅藻不会逃、不会打架，它靠的是身上那层用二氧化硅做的硬玻璃壳：又硬又透明，能挡住想咬它、想吃它的小动物，科学家还发现这层壳能帮它挡掉会伤害 DNA 的紫外线。所以它不靠攻击、靠'穿铠甲'保命——这就是游戏里'玻璃铠甲'出场给自己套护盾的来历。", difficulty: "medium", faction: "nature", cardId: "diatom", type: "mechanism", principle: "mechanism", tags: ["ch3","diatom","silica"] },
  { q: "硅藻又小、又不咬人，为什么说海里几乎所有动物都得'谢谢它'？", options: ["它会主动游过去喂饱海里的小鱼", "它光合造糖，是食物网最底层的饭", "它的玻璃壳能给小鱼当房子住", "它把海水里的盐吃光让小鱼更舒服"], answer: 1, fact: "硅藻会自养：用阳光把二氧化碳和水造成糖。海里的动物（异养）不能自己造食物，只能一层层往上吃——小虾吃硅藻、小鱼吃小虾、大鱼吃小鱼。能量的源头都是硅藻那一口光合作用，所以它是海洋食物网的根基。能量从哪来，决定了谁能活下来。", difficulty: "hard", faction: "nature", cardId: "diatom", type: "inference", principle: "mechanism", tags: ["ch3","diatom","food_chain"] },
  { q: "水熊虫遇到没水、太冷或太热的环境时，会做什么来保命？", options: ["缩成小桶进入隐生状态", "立刻游到很远的地方躲开", "长出厚厚的硬壳保护自己", "让身体变得很大吓退敌人"], answer: 0, fact: "环境一变糟，水熊虫会把身体里的水排掉、缩成一个圆滚滚的'小桶'(tun)，几乎停止身体里的一切活动——这招叫'隐生'(cryptobiosis)，是它最有名的保命绝技。", difficulty: "easy", faction: "nature", cardId: "tardigrade", type: "memorization", tags: ["ch3","tardigrade","cryptobiosis"] },
  { q: "水熊虫缩成'小桶'后，为什么能扛住太空真空和极冷极热？", options: ["小桶外面包了一层金属保护壳", "它在小桶里悄悄长出了新器官", "排掉水后几乎停止活动，把自己'封存'起来", "缩小以后体温会自动升得很高"], answer: 2, fact: "缩成小桶时，水熊虫把体内的水排掉、几乎停止呼吸和身体里的一切活动，相当于把自己'封存'休眠起来。没有水、身体又几乎不活动，极端的真空、辐射、高温和接近绝对零度的低温就很难破坏它——所以能硬扛。", difficulty: "medium", faction: "nature", cardId: "tardigrade", type: "mechanism", principle: "mechanism", tags: ["ch3","tardigrade","cryptobiosis"] },
  { q: "把缩成小桶的水熊虫放回有水的地方它就'活'过来了，这说明它之前是什么状态？", options: ["其实一直正常活着只是没动", "并没有真正死去，只是深度休眠", "已经死掉了，是新长出来一只", "已经变成了另外一种小动物"], answer: 1, fact: "缩成小桶的水熊虫并没有真的死，而是进入了极深的休眠：活动几乎停到看不出生命迹象。一旦重新遇到水，它就吸水'复活'继续爬动。所以它不是'不死之身'，而是靠'休眠硬扛、遇水复活'活成了最顽强的小动物。", difficulty: "hard", faction: "nature", cardId: "tardigrade", type: "inference", principle: "tradeoff", tags: ["ch3","tardigrade","cryptobiosis","extremophile"] },

  // ===== Phase 2 第三批（OCEAN 深海奇兵·共生 / MICRO 单细胞·细胞零件）=====
  // 寄居蟹
  { q: "寄居蟹住的'房子'是哪来的？", options: ["自己身上长出来的硬壳", "捡别的动物不要的空螺壳", "用沙子和泥巴堆的", "树枝搭起来的窝"], answer: 1, fact: "寄居蟹自己不长硬壳，软软的肚子怕被咬，就专门找空的海螺壳钻进去当'房子'保护自己。", difficulty: "easy", faction: "nature", cardId: "hermit_crab", type: "memorization", tags: ["phase2","hermit_crab","shell"] },
  { q: "寄居蟹为什么要不停地'换房子'（换壳）？", options: ["旧壳颜色不好看了", "身体长大了，旧壳住不下", "壳会自己融化掉", "为了交新朋友"], answer: 1, fact: "寄居蟹身体长大后，旧螺壳就住不下了，必须换一个更大的空壳。有时好几只还会按大小排成一队'接力换壳'。", difficulty: "medium", faction: "nature", cardId: "hermit_crab", type: "mechanism", principle: "mechanism", tags: ["phase2","hermit_crab","growth"] },
  { q: "有的寄居蟹把会蜇人的海葵驮在壳上：海葵帮它吓退敌人，它带海葵到处找吃的。这种关系叫什么？", options: ["互利共生（互相帮忙）", "你死我活的竞争", "寄生（一方占便宜）", "谁也不理谁"], answer: 0, fact: "海葵帮寄居蟹防御敌人，寄居蟹带着海葵移动、找到更多食物，双方都得好处、谁也不吃亏——这就是互利共生，和小丑鱼住海葵一个道理。", difficulty: "hard", faction: "nature", cardId: "hermit_crab", type: "inference", principle: "coevolution", tags: ["phase2","hermit_crab","symbiosis"] },
  // 清洁虾
  { q: "清洁虾在珊瑚礁的'清洁站'主要做什么？", options: ["帮大鱼清掉身上的寄生虫和死皮", "给大鱼喂食物", "帮大鱼搬家", "教小鱼游泳"], answer: 0, fact: "清洁虾会在固定地点开'清洁站'，帮游来的大鱼清掉身上的寄生虫、坏死的皮和食物残渣，连嘴里牙缝都清理干净。", difficulty: "easy", faction: "nature", cardId: "cleaner_shrimp", type: "memorization", tags: ["phase2","cleaner_shrimp","cleaning"] },
  { q: "凶猛的大鱼为什么张开嘴让小小的清洁虾钻进去，却不一口吃掉它？", options: ["大鱼的牙齿坏了咬不动它", "帮它清理身体让它健康，吃了没人帮忙", "清洁虾身上有可怕的剧毒", "大鱼根本就没看见它"], answer: 1, fact: "大鱼需要清洁虾帮它'看病'清理，吃掉它就再也没人帮忙了——所以大家都守规矩。这份'信任'让双方都活得更好，是互利共生。", difficulty: "medium", faction: "nature", cardId: "cleaner_shrimp", type: "mechanism", principle: "mutualism", tags: ["phase2","cleaner_shrimp","mutualism"] },
  { q: "清洁虾和大鱼互相帮忙、谁也离不开谁，这种关系和'小丑鱼住海葵'一样，叫什么？", options: ["互利共生", "捕食", "竞争", "寄生"], answer: 0, fact: "清洁虾吃饱、大鱼变健康，双方都得好处——这是互利共生。大自然里到处都有这种'合作双赢'的搭档关系。", difficulty: "hard", faction: "nature", cardId: "cleaner_shrimp", type: "inference", principle: "coevolution", tags: ["phase2","cleaner_shrimp","symbiosis"] },
  // 大王乌贼
  { q: "大王乌贼身上哪个器官是整个动物界最大的？", options: ["眼睛", "耳朵", "鼻子", "牙齿"], answer: 0, fact: "大王乌贼的眼睛直径能有27厘米、像个篮球，是动物界最大的眼睛！", difficulty: "easy", faction: "nature", cardId: "giant_squid", type: "memorization", tags: ["phase2","giant_squid","eye"] },
  { q: "在几乎没有阳光的深海，大王乌贼那双篮球大的眼睛有什么用？", options: ["用来吓唬敌人", "收集微弱的光，看清远处的猎物和危险", "当灯笼一样发光", "储存多余的食物"], answer: 1, fact: "深海几乎没有光，眼睛越大，能收集到的微弱光线就越多。超大的眼睛帮大王乌贼发现远处的猎物，也能更早看见抹香鲸这样的天敌。", difficulty: "medium", faction: "nature", cardId: "giant_squid", type: "mechanism", principle: "mechanism", tags: ["phase2","giant_squid","vision"] },
  { q: "抹香鲸的皮肤上常常有一圈圈圆形的伤疤，最可能是谁留下的？", options: ["大王乌贼的吸盘", "珊瑚划伤的", "渔网勒出来的", "晒太阳晒的"], answer: 0, fact: "抹香鲸潜到深海猎杀大王乌贼，大王乌贼会用布满吸盘的腕足拼命缠斗反抗，在抹香鲸皮肤上留下圆形吸盘印——那是深海搏斗的'勋章'。", difficulty: "hard", faction: "nature", cardId: "giant_squid", type: "inference", principle: "mechanism", tags: ["phase2","giant_squid","predator"] },
  // 座头鲸
  { q: "座头鲸的'泡泡网捕食'是怎么做的？", options: ["吐气泡织成网围住鱼群，一起吞下", "用泡泡把自己藏起来不被发现", "吹泡泡和同伴们玩游戏", "用泡泡把过路的船推走"], answer: 0, fact: "几头座头鲸一边绕圈游一边吐气泡，气泡升起像一张圆网把小鱼围住，然后大家一起从下往上冲、张口连水带鱼一起吞下。", difficulty: "easy", faction: "nature", cardId: "humpback_whale", type: "memorization", tags: ["phase2","humpback_whale","bubble_net"] },
  { q: "为什么说'泡泡网捕食'是一种了不起的本领？", options: ["因为一头鲸单独就能完成", "因为要好几头鲸合作、配合默契才行", "因为泡泡是有毒的", "因为是在岸上完成的"], answer: 1, fact: "泡泡网捕食需要好几头座头鲸分工合作：有的吐泡泡、有的赶鱼、一起冲上来——这种群体协作捕猎在动物界很少见。", difficulty: "medium", faction: "nature", cardId: "humpback_whale", type: "mechanism", principle: "cooperation", tags: ["phase2","humpback_whale","cooperation"] },
  { q: "雄座头鲸能唱好几个小时、声音传到很远很远，这'鲸歌'最主要的用处最可能是？", options: ["和远处的同伴交流、联络", "把鱼震晕好吃掉", "帮自己清洁牙齿", "让自己游得更快"], answer: 0, fact: "鲸歌能在海里传到几十甚至上百公里外，同一片海的座头鲸还会一起'换新歌'。科学家认为它主要用来和同伴交流联络——这是动物的一种语言。", difficulty: "hard", faction: "nature", cardId: "humpback_whale", type: "inference", principle: "mechanism", tags: ["phase2","humpback_whale","communication"] },
  // 蓝环章鱼
  { q: "蓝环章鱼受到威胁、生气时，身上会出现什么？", options: ["亮起一圈圈闪烁的蓝色环", "喷出黑色的墨汁", "长出尖尖的刺", "整个身体变透明"], answer: 0, fact: "平时它颜色暗暗的，一旦觉得有危险，身上几十个蓝色圆环会在不到一秒里突然亮起来、一闪一闪。", difficulty: "easy", faction: "nature", cardId: "blue_ringed_octopus", type: "memorization", tags: ["phase2","blue_ringed_octopus","blue_rings"] },
  { q: "蓝环章鱼亮出闪烁的蓝环，其实是在干什么？", options: ["吸引猎物靠近", "警告捕食者'我有剧毒，别碰我'", "求偶时跳舞", "给身体降温"], answer: 1, fact: "用鲜艳的颜色警告敌人'我有毒别碰我'，这招叫'警戒色'。自然界很多有毒的动物都用鲜亮颜色提醒别人离它远点。", difficulty: "medium", faction: "nature", cardId: "blue_ringed_octopus", type: "mechanism", principle: "mechanism", tags: ["phase2","blue_ringed_octopus","aposematism"] },
  { q: "在海边看到漂亮的小蓝环章鱼，正确的做法是？", options: ["只能看、不能碰，它带有剧毒", "抓起来带回家当宠物", "用手逗它，看它变色", "捧在手心里拍照"], answer: 0, fact: "蓝环章鱼只有巴掌大，毒性却极强，而且目前没有专门的解毒药。它亮蓝环就是在警告你别碰——看到了只能看、千万别碰。", difficulty: "hard", faction: "nature", cardId: "blue_ringed_octopus", type: "inference", principle: "tradeoff", tags: ["phase2","blue_ringed_octopus","venom","safety"] },
  // 古菌
  { q: "古菌最出名的本领，是能住在什么样的地方？", options: ["滚烫温泉、强酸、死咸盐湖这些极端环境", "只能住在干净的河水里", "只住在花盆的泥土里", "只住在冰箱的冷藏室"], answer: 0, fact: "很多古菌是'极端微生物'：有的泡在快烧开的温泉里，有的住在能腐蚀金属的酸水里，有的待在咸到别的生命都活不了的盐湖里。", difficulty: "easy", faction: "nature", cardId: "archaea", type: "memorization", tags: ["phase2","archaea","extremophile"] },
  { q: "科学家把地球上所有生命分成'三域'，下面哪一组才是这三大类？", options: ["细菌、古菌、真核生物", "鱼、鸟、兽", "植物、动物、石头", "大的、中的、小的"], answer: 0, fact: "地球生命分成三大'族'（三域）：细菌、古菌，还有包括动物植物真菌和我们人类的'真核生物'。古菌长得像细菌，其实是单独的一大类。", difficulty: "medium", faction: "nature", cardId: "archaea", type: "mechanism", principle: "classification", tags: ["phase2","archaea","three_domains"] },
  { q: "为什么科学家觉得'研究古菌也许能猜到别的星球上的生命长什么样'？", options: ["古菌会自己飞到外星球上去", "古菌能活在极端环境，外星环境也极端", "古菌会发出光当信号灯用", "古菌特别大，一眼就看得见"], answer: 1, fact: "外星球常常又冷又热又没空气，环境很'极端'。古菌正好能在地球最极端的地方活下来，所以科学家相信最早的生命、甚至外星生命，可能就长得像古菌。", difficulty: "hard", faction: "nature", cardId: "archaea", type: "inference", principle: "mechanism", tags: ["phase2","archaea","astrobiology"] },
  // 核糖体
  { q: "核糖体在细胞里的工作，是制造什么？", options: ["蛋白质", "骨头", "血液", "牙齿"], answer: 0, fact: "核糖体照着基因的'图纸'，把一个个叫'氨基酸'的小积木串成蛋白质——它是细胞里的'蛋白质3D打印机'。", difficulty: "easy", faction: "body", cardId: "ribosome", type: "memorization", tags: ["phase2","ribosome","protein"] },
  { q: "如果把基因（DNA）比作'设计图纸'，那核糖体最像什么？", options: ["照着图纸施工的工厂", "画图纸的设计师", "存放图纸的柜子", "撕掉图纸的人"], answer: 0, fact: "基因是'设计图'，核糖体就是照图施工的'工厂'，把图纸变成真正能干活的蛋白质。没有它，再好的图纸也变不成零件。", difficulty: "medium", faction: "body", cardId: "ribosome", type: "mechanism", principle: "mechanism", tags: ["phase2","ribosome","gene_to_protein"] },
  { q: "你的肌肉、消化食物的酶、血液里运氧的血红蛋白，全都是蛋白质。这说明核糖体为什么特别重要？", options: ["它造出身体几乎所有干活的'零件'", "它只是个好看的装饰", "它负责让人睡觉", "它专门用来制造糖"], answer: 0, fact: "身体里干活的'机器'几乎都是蛋白质，而蛋白质都由核糖体制造。所以它是把基因图纸变成生命活动的关键一环——几乎所有生命的细胞里都有它。", difficulty: "hard", faction: "body", cardId: "ribosome", type: "inference", principle: "mechanism", tags: ["phase2","ribosome","importance"] },
  // 酵母
  { q: "做面包时，面团为什么会变得松松软软、鼓起来？", options: ["酵母吃糖放出二氧化碳气体，把面团撑大", "面粉自己会膨胀", "因为加了很多很多水", "烤的时候缩小了"], answer: 0, fact: "面团里的酵母一边吃糖一边放出二氧化碳气体，气泡把面团撑得鼓鼓的，烤出来才松软。这个本领叫'发酵'。", difficulty: "easy", faction: "nature", cardId: "yeast", type: "memorization", tags: ["phase2","yeast","fermentation"] },
  { q: "酵母把糖分解（发酵）时，会产生哪两样东西？（一个让面包鼓起来，一个能酿酒）", options: ["二氧化碳气体和酒精", "只有水", "金属和沙子", "氧气和盐"], answer: 0, fact: "酵母发酵会把糖变成二氧化碳气体（让面包鼓起来）和酒精（用来酿酒），同时为自己获得能量。", difficulty: "medium", faction: "nature", cardId: "yeast", type: "mechanism", principle: "mechanism", tags: ["phase2","yeast","fermentation"] },
