...
export const quizzes = [
  ...
  { q: "切叶蚁把树叶搬回巢穴后会怎么处理？", options: ["直接吃掉", "用来盖房子", "用来种蘑菇", "给蚁后当床"], answer: 2, fact: "切叶蚁会把树叶嚼碎后当\"肥料\"种蘑菇，然后吃蘑菇！它们是最早的\"农民\"。", difficulty: "hard", faction: "nature", cardId: "ant_soldier", type: "memorization", principle: "coevolution", tags: ["legacy","ant","fungus_farming"] },
  ...
  { q: "红细胞是什么形状的？", options: ["圆球形", "中间凹下去的圆饼形", "方形", "三角形"], answer: 1, fact: "红细胞像中间凹下去的小圆饼，这种形状增大表面积能携带更多氧气！", difficulty: "easy", faction: "body", cardId: "red_blood_cell", type: "memorization", tags: ["legacy","rbc","biconcave_shape"] },
  ...
  { q: "心脏脱离身体后能继续跳动吗？", options: ["不能", "能，有自己的电信号系统", "只能跳1秒", "要看温度"], answer: 1, fact: "心脏有自己的\"发电站\"（窦房结），脱离身体也能继续跳一小会儿！", difficulty: "hard", faction: "body", cardId: "heart_engine", type: "memorization", tags: ["legacy","heart","autorhythmicity"] },
  ...
  { q: "打喷嚏时飞沫能飞多远？", options: ["30厘米", "1米", "可以飞到8米远", "只在鼻子附近"], answer: 2, fact: "打喷嚏时飞沫速度可达160公里/时，能飞到8米远！", difficulty: "medium", faction: "pathogen", cardId: "flu_virus", type: "memorization", tags: ["legacy","flu","droplet_range"] },
  ...
  { q: "绦虫有自己的消化系统吗？", options: ["有", "没有", "只有胃没有肠", "只有幼虫有"], answer: 1, fact: "绦虫完全没有消化系统！直接通过体表吸收宿主已消化的营养。", difficulty: "hard", faction: "pathogen", cardId: "tapeworm_lurker", type: "memorization", tags: ["legacy","tapeworm","no_digestive_system"] },
  ...
  { q: "伤口应该保持干燥还是湿润？", options: ["越干越好", "保持适度湿润愈合更快", "泡在水里最好", "没有区别"], answer: 1, fact: "现代医学发现伤口在适度湿润环境下愈合更快！", difficulty: "medium", faction: "tech", cardId: "bandaid_helper", type: "memorization", tags: ["legacy","bandaid","moist_healing"] },
