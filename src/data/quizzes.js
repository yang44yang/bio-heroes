...
export const quizzes = [
  ...
  // — 🦠 病原系 (1 题) —
  { q: "为什么用'牛痘'就能预防'天花'？", options: ["牛比人厉害", "牛痘和天花病毒长得很像，免疫系统认识一个就能对付另一个", "牛痘能杀死天花病毒", "牛痘是天花的解药"], answer: 1, fact: "牛痘和天花病毒的表面分子很相似！免疫系统认识了牛痘，就能识别并消灭真的天花——这是疫苗的核心原理。", difficulty: "medium", faction: "pathogen", cardId: "smallpox_ghost", type: "mechanism", principle: "mechanism", tags: ["ch2","vaccine"] },

  // — 🧬 人体系 (16 题) —
  { q: "为什么眼睛暴露在空气里却很少感染？", options: ["眼皮挡得好", "眼泪里的溶菌酶在持续杀菌", "眼睛温度低", "细菌不喜欢眼泪的味道"], answer: 1, fact: "眼泪不停冲洗眼球，里面的溶菌酶能破坏细菌的细胞壁——这是身体的'自动消毒系统'！", difficulty: "medium", faction: "body", cardId: "tear_drop_lysozyme", type: "mechanism", principle: "mechanism", tags: ["ch2","immune"] },
  { q: "睫毛为什么能保护眼睛？", options: ["睫毛会发出信号", "像小刷子物理拦截灰尘和小颗粒", "睫毛能杀菌", "睫毛会眨眼"], answer: 1, fact: "睫毛是物理屏障——异物碰到睫毛会触发条件反射的眨眼，把灰尘挡在眼外！", difficulty: "medium", faction: "body", cardId: "eyelash_interceptor", type: "mechanism", principle: "mechanism", tags: ["ch2","barrier"] },
  { q: "为什么出汗能让身体凉下来？", options: ["汗水本身是凉的", "汗水蒸发时会带走身体的热量", "汗腺打开就散热", "汗水洗掉了热气"], answer: 1, fact: "液体蒸发会吸热——汗水从皮肤蒸发时把热量带到空气里，就像给身体装了'天然空调'！", difficulty: "medium", faction: "body", cardId: "sweat_gland_cooler", type: "mechanism", principle: "homeostasis", tags: ["ch2","cooling"] },
  { q: "小肠为什么要长出几百万根绒毛？", options: ["让小肠更结实", "在有限的空间里大大增加吸收营养的接触面积", "防止食物太快通过", "帮助分泌消化液"], answer: 1, fact: "肚子里装不下网球场那么大的肠子，但靠'绒毛+小绒毛'的折叠结构，吸收面积可以等于一个网球场！", difficulty: "medium", faction: "body", cardId: "small_intestine_absorber", type: "mechanism", principle: "tradeoff", tags: ["ch2","digestive"] },
  { q: "为什么生病时淋巴结会肿起来？", options: ["发炎了", "大量免疫细胞聚集在那里跟病原作战", "血流变慢", "积液了"], answer: 1, fact: "淋巴结是免疫'军事基地'——一打仗就会有大量 B 细胞、T 细胞涌入并增殖，体积就肿起来了！", difficulty: "medium", faction: "body", cardId: "lymph_node_filter", type: "mechanism", principle: "mechanism", tags: ["ch2","immune"] },
  { q: "肾脏为什么要每天过滤这么多血？", options: ["肾脏闲不住", "细胞代谢不停产生废物，必须持续清除", "为了消耗能量", "保持血液温度"], answer: 1, fact: "你身体里的细胞每秒都在代谢产生废物。如果肾脏停一天，毒素就会积累到危险水平——这就是为什么要持续过滤。", difficulty: "medium", faction: "body", cardId: "kidney_filter", type: "mechanism", principle: "homeostasis", tags: ["ch2","filtration"] },
  { q: "为什么造血干细胞躲在骨头里？", options: ["骨头里没事干", "硬骨头保护幼小的血细胞不受外界伤害", "骨头里温度高", "骨头里有蛋白质"], answer: 1, fact: "骨髓藏在最硬的骨头里——给娇嫩的造血干细胞建了一个'保险柜'，外界压力、辐射都进不去！", difficulty: "medium", faction: "body", cardId: "bone_marrow_forge", type: "mechanism", principle: "mechanism", tags: ["ch2","protection"] },
  { q: "干细胞为什么能变成各种不同的细胞？", options: ["它有特异功能", "它还没'决定'长成什么，所有基因开关都还可以打开", "它会复制其他细胞", "它体积特别大"], answer: 1, fact: "成熟细胞的基因有的已经'锁死'了，但干细胞所有基因开关都没锁——所以理论上可以长成任何细胞！", difficulty: "medium", faction: "body", cardId: "stem_cell_morph", type: "mechanism", principle: "mechanism", tags: ["ch2","stem_cell"] },
  { q: "肝脏为什么是身体最大的内脏？", options: ["长得快", "它要做 500 多种工作，需要超大量的细胞", "重力让它变大", "因为吃得多"], answer: 1, fact: "肝脏要解毒、储糖、合成蛋白、产胆汁……几百项工作叠在一起，所以需要 1.5 公斤那么多细胞！", difficulty: "medium", faction: "body", cardId: "liver_detox", type: "mechanism", principle: "mechanism", tags: ["ch2","multifunction"] },
  { q: "树突细胞为什么要把病原的'身份证'拿给 T 细胞看？", options: ["让 T 细胞知道敌人长什么样，才能精准消灭", "礼貌", "给 T 细胞看个热闹", "教 T 细胞认字"], answer: 0, fact: "T 细胞不能直接看到病原。树突细胞把病原的特征分子'展示'给 T 细胞——这叫抗原呈递，是免疫精准打击的关键！", difficulty: "medium", faction: "body", cardId: "dendrite_scout", type: "mechanism", principle: "mechanism", tags: ["ch2","immune","antigen"] },
  { q: "脾脏为什么要把老红血球的铁回收？", options: ["铁稀有，造血必需，不能浪费", "防止环境污染", "习惯", "铁能赚钱"], answer: 0, fact: "人体的铁很难从食物里获取，而每个红血球都需要铁！脾脏把老红血球里的铁回收，送回骨髓造新血——精打细算！", difficulty: "medium", faction: "body", cardId: "spleen_recycler", type: "mechanism", principle: "tradeoff", tags: ["ch2","recycle"] },
  { q: "巨噬细胞为什么能一口气吞掉那么多细菌？", options: ["它特别能吃", "它能反复制造消化酶把细菌分解", "它有特殊的胃", "它吞了不消化"], answer: 1, fact: "巨噬细胞内有溶酶体——细菌一吞进去就被消化酶分解。消化完一个再吞下一个，理论上可以吞上百个！", difficulty: "medium", faction: "body", cardId: "macrophage_tank", type: "mechanism", principle: "mechanism", tags: ["ch2","immune","phagocytosis"] },
  { q: "DNA 修不好的时候，细胞为什么要'自杀'？", options: ["细胞气馁了", "为了防止变成癌细胞，牺牲自己保全身体", "没能量了", "被毒死了"], answer: 1, fact: "DNA 错误如果带着继续分裂，可能变成癌细胞威胁整个身体。所以坏细胞会启动'凋亡程序'自我了断——这是'局部牺牲，全局安全'！", difficulty: "medium", faction: "body", cardId: "dna_repair_crew", type: "mechanism", principle: "tradeoff", tags: ["ch2","apoptosis"] },
  { q: "为什么每种抗体只能识别一种特定的病原？", options: ["抗体很挑剔", "抗体的形状像钥匙，要跟病原的'锁'形状匹配", "抗体只学会一种", "抗体记不住其他病原"], answer: 1, fact: "抗体的 Y 形末端有一个特殊的'锁孔'，只能跟某一种病原表面的分子精确咬合——这是免疫系统精准的根本原因！", difficulty: "medium", faction: "body", cardId: "antibody_precision_ssr", type: "mechanism", principle: "mechanism", tags: ["ch2","immune","specificity"] },
  { q: "T 细胞在胸腺的淘汰率为什么高达 95%？", options: ["胸腺空间太小", "要淘汰掉那些可能误伤自己人的'叛徒' T 细胞", "T 细胞活不久", "考试太难"], answer: 1, fact: "T 细胞的攻击力很强，如果误把自己人当敌人就是'自身免疫病'。胸腺像严格的学校：能区分自己/外人才能毕业，95% 不合格的都淘汰！", difficulty: "medium", faction: "body", cardId: "thymus_academy", type: "mechanism", principle: "tradeoff", tags: ["ch2","immune","autoimmune"] },
  { q: "为什么线粒体有自己的 DNA，跟细胞核 DNA 不一样？", options: ["细胞分配错了", "远古时它本来是独立的细菌，被细胞吞了之后留下来共生", "备份用", "演化错误"], answer: 1, fact: "20 亿年前，线粒体的祖先是独立细菌，被大细胞吞下来共生——所以它保留了自己的细菌 DNA！这叫'内共生学说'。", difficulty: "medium", faction: "body", cardId: "mitochondria_powerhouse", type: "mechanism", principle: "coevolution", tags: ["ch2","endosymbiosis"] },

  // — ⚗️ 科技系 (16 题) —
  { q: "为什么医生强调洗手要 20 秒，不能冲一下就行？", options: ["凑时间好记", "时间不够肥皂没法把细菌从皮肤褶皱里'撬'出来", "20 秒水流最干净", "让你享受洗手"], answer: 1, fact: "细菌喜欢躲在皮肤褶皱、指甲缝里。肥皂的分子需要 20 秒才能把它们包裹、剥离、冲走——这是化学+物理双重过程！", difficulty: "medium", faction: "tech", cardId: "hand_sanitizer", type: "mechanism", principle: "mechanism", tags: ["ch2","hygiene"] },
  { q: "为什么戴口罩'保护别人'比'保护自己'更重要？", options: ["自己更结实", "口罩主要挡住呼吸时喷出的飞沫，阻止病毒外传", "别人比自己重要", "口罩反着戴最有效"], answer: 1, fact: "口罩擅长挡住从嘴喷出的大液滴。如果每个人都戴，病毒在人群中就传不出去——这就是为什么疫情中'人人戴口罩'的策略最有效！", difficulty: "medium", faction: "tech", cardId: "surgical_mask", type: "mechanism", principle: "mechanism", tags: ["ch2","public_health"] },
  { q: "为什么现代纱布里要加银离子？", options: ["让它看起来高档", "银离子有很强的杀菌作用，能防止伤口感染", "让纱布更结实", "银能吸血"], answer: 1, fact: "银离子能破坏细菌的细胞膜和蛋白质——古人就发现金属银碗装的水不容易腐败！现代医用纱布把这个原理用在伤口上。", difficulty: "medium", faction: "tech", cardId: "bandage_wrap", type: "mechanism", principle: "mechanism", tags: ["ch2","antibacterial"] },
  { q: "为什么阿司匹林又能止痛又能预防心脏病？", options: ["它是多功能万能药", "它能阻止血小板凝集，既减炎症又防血栓", "它有两种成分", "它会自己识别问题"], answer: 1, fact: "阿司匹林阻断了一种叫前列腺素的物质——前列腺素既负责疼痛信号，又让血小板'抱团'形成血栓。一招阻断，两个效果！", difficulty: "medium", faction: "tech", cardId: "aspirin_pill", type: "mechanism", principle: "mechanism", tags: ["ch2","drug"] },
  { q: "为什么一滴血就能告诉医生这么多事？", options: ["医生猜得准", "血液在全身循环，会反映各个器官的状态", "仪器很贵", "血液会说话"], answer: 1, fact: "血液经过每个器官，会把'代谢废物'带出来。所以血糖、肝酶、肾功能指标……每一项都是某个器官在'发邮件汇报'！", difficulty: "medium", faction: "tech", cardId: "blood_test_kit", type: "mechanism", principle: "mechanism", tags: ["ch2","systems"] },
  { q: "为什么益生菌能让肠道更健康？", options: ["它们好吃", "它们和有害细菌抢食物 + 训练免疫系统", "它们消化能力强", "它们会唱歌"], answer: 1, fact: "肠道空间和食物有限——益生菌占了位置和食物，坏细菌就没地方繁殖。它们还会刺激免疫系统保持警觉！", difficulty: "medium", faction: "tech", cardId: "probiotics_ally", type: "mechanism", principle: "tradeoff", tags: ["ch2","microbiome"] },
  { q: "PCR 为什么能检测到微量的病毒？", options: ["它特别敏感", "它把一段 DNA 复制成几百万份，让微量信号变得明显", "它能放大病毒本身", "它会预测病毒"], answer: 1, fact: "PCR 像'分子复印机'——一段几个分子的 DNA 经过 30 次循环复制，能变成 10 亿份！信号放大让原本看不见的病毒被检出。", difficulty: "medium", faction: "tech", cardId: "pcr_machine", type: "mechanism", principle: "mechanism", tags: ["ch2","amplification"] },
  { q: "为什么机器人手术能比人手更精准？", options: ["机器人更聪明", "机器臂不抖，能做几毫米的精细操作", "机器人不睡觉", "机器人有 X 光眼"], answer: 1, fact: "人手再稳也会有微小抖动，长时间手术更明显。机器臂没有抖动，加上电脑过滤医生手的颤抖——能精确到 0.1 毫米！", difficulty: "medium", faction: "tech", cardId: "robotic_surgery", type: "mechanism", principle: "mechanism", tags: ["ch2","precision"] },
  { q: "除颤器是怎么让心脏重新跳动的？", options: ["把心脏'打醒'", "用电击重置心脏的混乱电信号，让它重新有节奏", "把心脏'吓回来'", "注射肾上腺素"], answer: 1, fact: "心脏骤停常是因为肌肉在'乱抖'（颤动）。一次强电流让所有肌肉同时'重启'，恢复有节奏的跳动——就像电脑重启卡死。", difficulty: "medium", faction: "tech", cardId: "defibrillator_restart", type: "mechanism", principle: "mechanism", tags: ["ch2","emergency","reset"] },
  { q: "CT 为什么要绕着身体拍几百张片子？", options: ["机器质量差", "电脑要从多个角度的切片拼成 3D 图像", "为了赚钱", "病人会动"], answer: 1, fact: "一张 X 光只是'压扁'的影子，看不出深度。CT 从几百个角度拍，电脑算法把每个角度的信息重建成 3D——所以能看到器官的'切片'！", difficulty: "medium", faction: "tech", cardId: "ct_scanner_reveal", type: "mechanism", principle: "mechanism", tags: ["ch2","imaging","3d"] },
  { q: "基因治疗为什么能治好一些先天性疾病？", options: ["它能改运", "用正确的基因替换有缺陷的基因，从源头修复", "它强化免疫力", "它让人重新长一遍"], answer: 1, fact: "很多先天病是 DNA 上某个基因坏了。基因治疗把正确的基因送进细胞，从根源上让细胞恢复正常工作——治本不治标！", difficulty: "medium", faction: "tech", cardId: "gene_therapy_fix", type: "mechanism", principle: "mechanism", tags: ["ch2","genetics","root_cause"] },
  { q: "透析机为什么需要一层'特殊的膜'？", options: ["美观", "膜让小分子毒素出去，大分子蛋白质留下", "给血加温", "防止漏出"], answer: 1, fact: "膜上有微小的孔——尿素等小毒素能挤过去被冲走，但蛋白质、血细胞这些大分子留下来。这叫'选择性过滤'，跟真肾脏一样！", difficulty: "medium", faction: "tech", cardId: "dialysis_machine", type: "mechanism", principle: "mechanism", tags: ["ch2","selective_filtration"] },
  { q: "mRNA 疫苗为什么不需要灭活病毒？", options: ["设计师偷懒", "它给细胞发一个'指令'，让细胞自己造一小段病毒蛋白让免疫系统认识", "mRNA 不会致病", "mRNA 会变成病毒"], answer: 1, fact: "传统疫苗要先培养病毒再灭活。mRNA 疫苗跳过这步——直接送一段'图纸'让细胞产出关键蛋白，免疫系统拿来训练，又快又安全！", difficulty: "medium", faction: "tech", cardId: "mrna_vaccine", type: "mechanism", principle: "mechanism", tags: ["ch2","vaccine","mrna"] },
  { q: "纳米机器人怎么'精准找到'癌细胞？", options: ["它会问路", "它带有抗体，能识别癌细胞表面特殊的分子标记", "它跟着血流走", "它有 GPS"], answer: 1, fact: "癌细胞表面有跟正常细胞不一样的分子。纳米机器人表面装着这种分子的'抗体'，只有遇到癌细胞才会粘上——就像精确锁定的钥匙！", difficulty: "medium", faction: "tech", cardId: "nanobot_warrior", type: "mechanism", principle: "mechanism", tags: ["ch2","molecular_recognition"] },
  { q: "CRISPR 为什么能精确地剪 DNA 的某一段？", options: ["它记得所有 DNA 序列", "它用一段'引导 RNA'当地图，找到匹配的位置才剪", "它有锋利的刀", "它专门剪坏基因"], answer: 1, fact: "CRISPR 由 RNA + 蛋白质组成——RNA 序列决定剪哪里！想换地方剪，只要换 RNA 序列就行，所以才能'精确'到任何想要的位置。", difficulty: "medium", faction: "tech", cardId: "crispr_editor", type: "mechanism", principle: "mechanism", tags: ["ch2","genetics","guide_rna"] },
  { q: "AI 为什么能在影像诊断上超过人类医生？", options: ["AI 更聪明", "AI 看过几百万张图片，能记住所有细微的特征模式", "人类医生不努力", "AI 不会累"], answer: 1, fact: "顶级医生一辈子看几万张片子，AI 一次训练能看几百万张！数据规模带来的模式识别能力，是 AI 在影像上超过人类的根本原因。", difficulty: "medium", faction: "tech", cardId: "ai_doctor", type: "mechanism", principle: "mechanism", tags: ["ch2","ai","scale"] },

  // — 部分覆盖卡补机制题 (3 题) —
  { q: "蛀牙菌怎么把牙齿弄坏的？", options: ["用牙咬", "把吃的糖发酵成酸，腐蚀牙釉质", "撞坏的", "让牙齿生病"], answer: 1, fact: "蛀牙菌吃了糖后会产酸——酸长期接触牙齿就把牙釉质溶解出小洞！这就是为什么吃完糖要漱口或刷牙。", difficulty: "medium", faction: "pathogen", cardId: "cavity_bacteria", type: "mechanism", principle: "mechanism", tags: ["ch2","acid"] },
  { q: "红细胞为什么能携带那么多氧气？", options: ["红色容易吸氧", "它里面装满了血红蛋白，每个血红蛋白能可逆地结合氧", "它中空像气球", "它会主动呼吸"], answer: 1, fact: "每个红细胞里有 2.8 亿个血红蛋白分子！血红蛋白在肺里抓住氧，到了缺氧组织就松开氧——这种'可逆结合'是运氧的关键。", difficulty: "medium", faction: "body", cardId: "red_blood_cell", type: "mechanism", principle: "mechanism", tags: ["ch2","oxygen","reversible_binding"] },
  { q: "体温计为什么遇热会显示更高的数字？", options: ["它感觉到痛", "玻璃管里的液体（汞或酒精）受热膨胀，刻度就升高", "数字会跳", "体温计有电池"], answer: 1, fact: "液体受热体积变大——传统体温计就是用这个原理，把温度变化转换成液柱高度变化！这是物理学'热胀冷缩'最简单的应用。", difficulty: "medium", faction: "tech", cardId: "thermometer_alarm", type: "mechanism", principle: "mechanism", tags: ["ch2","physics","thermal_expansion"] },
]
