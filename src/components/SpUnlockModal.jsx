    ...
    >
      ...
      >
        ...
        <div className="bg-gray-900/60 rounded-lg p-4 mb-5 text-left">
          <div className="text-xs text-yellow-300 font-bold mb-1">⚗️ 效果</div>
          <div className="text-white text-xs leading-relaxed mb-3">
            {sp.skills?.[0]?.description || '强力 SP 技能'}
          </div>
          <div className="text-xs text-yellow-300 font-bold mb-1">📚 科学知识</div>
